...
public readonly class SequencesKt__SequencesKt$asSequence$$inlined$Sequence$1<T> : kotlin.sequences.Sequence<T> {
    readonly java.util.IEnumerator $this_asSequence$inlined;

    public SequencesKt__SequencesKt$asSequence$$inlined$Sequence$1(java.util.IEnumerator it) {
