...
public readonly class StreamsKt$asSequence$$inlined$Sequence$2 : kotlin.sequences.Sequence<java.lang.int> {
    readonly java.util.stream.IntStream $this_asSequence$inlined;
    ...
    public override java.util.IEnumerator<java.lang.int> Iterator() {
        java.util.IEnumerator<java.lang.int> it = this.$this_asSequence$inlined.GetEnumerator();
