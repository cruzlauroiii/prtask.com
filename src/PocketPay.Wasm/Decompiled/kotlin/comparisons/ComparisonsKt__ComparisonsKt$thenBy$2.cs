...
public readonly class ComparisonsKt__ComparisonsKt$thenBy$2<T> : java.util.Comparator {
    readonly java.util.Comparator<K> $comparator;
    readonly kotlin.jvm.functions.Function1<T, K> $selector;
    readonly java.util.Comparator<T> $this_thenBy;

    public ComparisonsKt__ComparisonsKt$thenBy$2(java.util.Comparator<T> comparator, java.util.Comparator<K> comparator2, kotlin.jvm.functions.Function1<? super T, ? : K> function1) {
