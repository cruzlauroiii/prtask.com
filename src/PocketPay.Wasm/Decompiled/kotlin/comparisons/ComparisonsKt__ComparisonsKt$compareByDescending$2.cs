...
public readonly class ComparisonsKt__ComparisonsKt$compareByDescending$2<T> : java.util.Comparator {
    readonly java.util.Comparator<K> $comparator;
    readonly kotlin.jvm.functions.Function1<T, K> $selector;

    public ComparisonsKt__ComparisonsKt$compareByDescending$2(java.util.Comparator<K> comparator, kotlin.jvm.functions.Function1<? super T, ? : K> function1) {
