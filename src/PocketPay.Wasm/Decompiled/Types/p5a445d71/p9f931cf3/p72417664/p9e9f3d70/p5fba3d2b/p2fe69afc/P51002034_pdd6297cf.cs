...
public class P51002034_pdd6297cf : P51002034
{
    ...
    {
        // call: p51002034.engineIsCertificateEntry
        return false;
    }

    public bool EngineIsKeyEntry(string P0)
    {
        // call: p51002034.engineIsKeyEntry
        return false;
    }

    public void EngineLoad(Stream P0, char[] P1)
    {
        // call: p51002034.engineLoad
    }
    ...
    {
        // call: p51002034.engineSetCertificateEntry
    }

    public void EngineSetKeyEntry(string P0, Key P1, char[] P2, Certificate[] P3)
    {
        // call: p51002034.engineSetKeyEntry
    }
    ...
    {
        // call: p51002034.engineSize
        return 0;
    }

    public void EngineStore(Stream P0, char[] P1)
    {
        // call: p51002034.engineStore
    }
