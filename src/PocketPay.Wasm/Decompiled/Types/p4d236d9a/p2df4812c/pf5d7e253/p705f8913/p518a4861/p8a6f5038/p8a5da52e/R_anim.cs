...
public class R_anim
{
    ...
    public static int Fade_in_long;
    public static int Fade_out;
    public static int Fade_out_long;
    ...
    public static int M3_bottom_sheet_slide_in;
    public static int M3_bottom_sheet_slide_out;
    public static int M3_motion_fade_enter;
    public static int M3_motion_fade_exit;
    public static int M3_side_sheet_enter_from_left;
    public static int M3_side_sheet_enter_from_right;
    public static int M3_side_sheet_exit_to_left;
    public static int M3_side_sheet_exit_to_right;
    ...
    public static int Print_receipt_edge_anim;
    public static int Print_receipt_line1_anim;
    public static int Print_receipt_line2_anim;
    public static int Print_receipt_line3_anim;
    public static int Print_receipt_line4_anim;
    public static int Print_receipt_line5_anim;
    public static int Print_receipt_line6_anim;
