...
public readonly class p62d58733$pfa7153f7$pd41d8cd9$pec404527$p7f662005$1 : kotlin.properties.ReadWriteProperty<java.lang.object, java.lang.int> {
    ...
    public p62d58733$pfa7153f7$pd41d8cd9$pec404527$p7f662005$1(android.content.Dictionary<string, object> sharedPreferences, java.lang.string str, java.lang.object obj) {
        this.$this_delegate = sharedPreferences;
        this.$key = str;
        this.$defaultValue = obj;
    }

    public override java.lang.int GetValue(java.lang.object thisRef, kotlin.reflect.KProperty<object> property) {
        ...
        return java.lang.int.valueOf(this.$this_delegate.getInt(this.$key, ((java.lang.Number) this.$defaultValue).intValue()));
    }

    public override void SetValue(java.lang.object thisRef, kotlin.reflect.KProperty<object> property, java.lang.int value) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(thisRef, "thisRef");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(property, "property");
        ...
        sharedPreferences$EditorEdit.putInt(this.$key, value.intValue()).apply();
    }
}
