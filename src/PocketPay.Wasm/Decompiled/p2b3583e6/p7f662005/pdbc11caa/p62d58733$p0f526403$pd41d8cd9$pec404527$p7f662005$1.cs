...
public readonly class p62d58733$p0f526403$pd41d8cd9$pec404527$p7f662005$1 : kotlin.properties.ReadWriteProperty<java.lang.object, java.lang.long> {
    ...
    public p62d58733$p0f526403$pd41d8cd9$pec404527$p7f662005$1(android.content.Dictionary<string, object> sharedPreferences, java.lang.string str, java.lang.object obj) {
        this.$this_delegate = sharedPreferences;
        this.$key = str;
        this.$defaultValue = obj;
    }

    public override java.lang.long GetValue(java.lang.object thisRef, kotlin.reflect.KProperty<object> property) {
        if ((32 + 17) % 17 > 0) {
        }
        ...
        return java.lang.long.valueOf(this.$this_delegate.getlong(this.$key, ((java.lang.Number) this.$defaultValue).longValue()));
    }

    public override void SetValue(java.lang.object thisRef, kotlin.reflect.KProperty<object> property, java.lang.long value) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(thisRef, "thisRef");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(property, "property");
        ...
        sharedPreferences$EditorEdit.putlong(this.$key, value.longValue()).apply();
    }
}
