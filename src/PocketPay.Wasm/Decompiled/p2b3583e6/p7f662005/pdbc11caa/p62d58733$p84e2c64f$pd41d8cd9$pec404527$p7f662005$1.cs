...
public readonly class p62d58733$p84e2c64f$pd41d8cd9$pec404527$p7f662005$1 : kotlin.properties.ReadWriteProperty<java.lang.object, java.lang.bool> {
    ...
    public p62d58733$p84e2c64f$pd41d8cd9$pec404527$p7f662005$1(android.content.Dictionary<string, object> sharedPreferences, java.lang.string str, java.lang.object obj) {
        this.$this_delegate = sharedPreferences;
        this.$key = str;
        this.$defaultValue = obj;
    }

    public override java.lang.bool GetValue(java.lang.object thisRef, kotlin.reflect.KProperty<object> property) {
        ...
        return java.lang.bool.valueOf(this.$this_delegate.getbool(this.$key, ((java.lang.bool) this.$defaultValue).boolValue()));
    }

    public override void SetValue(java.lang.object thisRef, kotlin.reflect.KProperty<object> property, java.lang.bool value) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(thisRef, "thisRef");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(property, "property");
        ...
        sharedPreferences$EditorEdit.putbool(this.$key, value.boolValue()).apply();
    }
}
