...
public readonly class p62d58733$pb45cffe0$pd41d8cd9$pec404527$p7f662005$1 : kotlin.properties.ReadWriteProperty<java.lang.object, java.lang.string> {
    ...
    public p62d58733$pb45cffe0$pd41d8cd9$pec404527$p7f662005$1(android.content.Dictionary<string, object> sharedPreferences, java.lang.string str, java.lang.object obj) {
        this.$this_delegate = sharedPreferences;
        this.$key = str;
        this.$defaultValue = obj;
    }

    public override java.lang.string GetValue(java.lang.object thisRef, kotlin.reflect.KProperty<object> property) {
        ...
        return p2b3583e6.p7f662005.pdbc11caa.p62d58733.mdc7891c6(this.$this_delegate, this.$key, (java.lang.string) this.$defaultValue);
    }

    public override void SetValue(java.lang.object thisRef, kotlin.reflect.KProperty<object> property, java.lang.string value) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(thisRef, "thisRef");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(property, "property");
        ...
        sharedPreferences$EditorEdit.putstring(this.$key, value).apply();
    }
}
