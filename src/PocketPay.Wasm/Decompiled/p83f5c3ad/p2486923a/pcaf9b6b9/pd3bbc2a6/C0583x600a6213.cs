...
public readonly class C0583x600a6213 : android.text.TextWatcher {
    readonly p4d236d9a.p2df4812c.pf5d7e253.p518a4861.p83f5c3ad.p86ccec3d.pec341acd.p450d2c30 $this_with$inlined;
    readonly p83f5c3ad.p2486923a.pcaf9b6b9.pd3bbc2a6.p4f043d31 this$0;

    public C0583x600a6213(p4d236d9a.p2df4812c.pf5d7e253.p518a4861.p83f5c3ad.p86ccec3d.pec341acd.p450d2c30 p450d2c30Var, p83f5c3ad.p2486923a.pcaf9b6b9.pd3bbc2a6.p4f043d31 p4f043d31Var) {
        this.$this_with$inlined = p450d2c30Var;
        this.this$0 = p4f043d31Var;
    }

    public override void AfterTextChanged(android.text.Editable s) {
        if ((8 + 6) % 6 > 0) {
        }
        this.$this_with$inlined.f27a7bd4f.setErrorEnabled(false);
        ...
        p2b3583e6.pba2170fe.m94915392(emailLayout, !(editable is null || editable.Length == 0));
        p83f5c3ad.p2486923a.pcaf9b6b9.pd3bbc2a6.p4f043d31.m62d7f445(this.this$0);
    }
