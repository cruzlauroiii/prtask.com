...
public readonly class C0581xf7697936 : android.text.TextWatcher {
    ...
    public C0581xf7697936(p83f5c3ad.p2486923a.p70a17ffa.p76ea0beb.p7edc83db p7edc83dbVar, p4d236d9a.p2df4812c.pf5d7e253.p518a4861.p83f5c3ad.p86ccec3d.pec341acd.pfcf18117 pfcf18117Var) {
    ...
    public override void AfterTextChanged(android.text.Editable s) {
        ...
        p5c3f05adVarMf6143d8e.onInnChanged(string);
        if (s.Length != 0) {
            com.google.android.material.textfield.TextInputLayout innLayout = this.$this_with$inlined.f49c7c094;
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(innLayout, "innLayout");
            p2b3583e6.pba2170fe.m9996d2f1(innLayout, p4d236d9a.p2df4812c.pf5d7e253.p518a4861.p83f5c3ad.p86ccec3d.R$drawable.ic_toph_clear);
        } else {
            com.google.android.material.textfield.TextInputLayout innLayout2 = this.$this_with$inlined.f49c7c094;
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(innLayout2, "innLayout");
            p2b3583e6.pba2170fe.mbb2331dd(innLayout2);
        }
    }
