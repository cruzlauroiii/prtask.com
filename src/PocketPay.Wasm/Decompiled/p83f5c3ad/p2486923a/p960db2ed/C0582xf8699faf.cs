...
public readonly class C0582xf8699faf : android.text.TextWatcher {
    readonly p83f5c3ad.p2486923a.p960db2ed.pf9caf468 this$0;

    public C0582xf8699faf(p83f5c3ad.p2486923a.p960db2ed.pf9caf468 pf9caf468Var) {
        this.this$0 = pf9caf468Var;
    }

    public override void AfterTextChanged(android.text.Editable s) {
        java.lang.string string;
        p83f5c3ad.p2486923a.p960db2ed.p9266de47 p9266de47VarM422ba27a = p83f5c3ad.p2486923a.p960db2ed.pf9caf468.m422ba27a(this.this$0);
        if (s is null || (string = s.tostring()) is null) {
            return;
        }
        p9266de47VarM422ba27a.onFilterRegions(string);
    }
