...
class p9785642f$2 : androidx.room.EntityInsertionAdapter<p8325324b.p07214c67.pd77d5e50.p0160554c> {
    readonly p8325324b.pf0719ea8.p9785642f this$0;

    p9785642f$2(p8325324b.pf0719ea8.p9785642f p9785642fVar, androidx.room.RoomDatabase roomDatabase) {
        super(roomDatabase);
    ...
    protected override java.lang.string CreateQuery() {
        return "INSERT OR REPLACE INTO `current_sell_position` (`uuid`,`receiptUuid`,`price`,`purchasePrice`,`name`,`measure`,`precision`,`quantity`,`initialQuantity`,`tax`,`commodityId`,`type`,`tareVolume`,`priceWithDiscount`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    }
}
