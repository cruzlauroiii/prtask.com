...
class p9785642f$3 : androidx.room.EntityInsertionAdapter<p8325324b.p07214c67.pd77d5e50.p32a285cf> {
    readonly p8325324b.pf0719ea8.p9785642f this$0;

    p9785642f$3(p8325324b.pf0719ea8.p9785642f p9785642fVar, androidx.room.RoomDatabase roomDatabase) {
        super(roomDatabase);
    ...
    protected override java.lang.string CreateQuery() {
        return "INSERT OR REPLACE INTO `current_sell_payment` (`uuid`,`receiptUuid`,`paymentType`,`amount`,`tapOnPhoneRefId`,`transaction_rrn`,`transaction_stan`,`transaction_authCode`,`transaction_responseCode`,`transaction_topRefUuid`,`transaction_terminalId`,`transaction_merchantId`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
    }
}
