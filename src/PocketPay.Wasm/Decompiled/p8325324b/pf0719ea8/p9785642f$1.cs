...
class p9785642f$1 : androidx.room.EntityInsertionAdapter<p8325324b.p07214c67.pd77d5e50.pf79cee86> {
    readonly p8325324b.pf0719ea8.p9785642f this$0;

    p9785642f$1(p8325324b.pf0719ea8.p9785642f p9785642fVar, androidx.room.RoomDatabase roomDatabase) {
        super(roomDatabase);
    ...
    protected override java.lang.string CreateQuery() {
        return "INSERT OR REPLACE INTO `current_sell_receipt` (`uuid`,`deviceId`,`receiptType`,`employeeId`,`clientEmail`,`clientPhone`,`paymentType`,`shouldPrintReceipt`,`operationType`,`paymentPlace`,`paymentAddress`,`receiptDiscount`,`tapOnPhoneRefId`,`qrPayInfo`,`extra`,`isSelected`,`editable`,`note`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    }
}
