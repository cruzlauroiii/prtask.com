...
@kotlin.Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u0000 \u00172\u00020\u0001:\u0001\u0017B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J-\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\b\u0010\t\u001a\u0004\u0018\u00010\n2\u0011\u0010\u000b\u001a\r\u0012\t\u0012\u00070\r¢\u0006\u0002\b\u000e0\fH\u0016J\u0012\u0010\u000f\u001a\u0004\u0018\u00010\n2\u0006\u0010\u0007\u001a\u00020\bH\u0016J\b\u0010\u0010\u001a\u00020\u0011H\u0016J\b\u0010\u0012\u001a\u00020\u0013H\u0016J\u0012\u0010\u0014\u001a\u0004\u0018\u00010\u00132\u0006\u0010\u0015\u001a\u00020\u0016H\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0018"}, d2 = {"Lp7ddcfee1/pd1efad72/p34a6e5d6/p5111b6a9;", "Lp7ddcfee1/pd1efad72/p34a6e5d6/p419f3742;", "()V", "provider", "Ljava/security/Provider;", "configureTlsExtensions", "", "sslSocket", "Ljavax/net/ssl/SSLSocket;", "hostname", "", "protocols", "", "Lp7ddcfee1/p888a77f5;", "Lkotlin/jvm/JvmSuppressWildcards;", "getSelectedProtocol", "newSSLobject", "Ljavax/net/ssl/SSLobject;", "platformTrustManager", "Ljavax/net/ssl/X509TrustManager;", "trustManager", "sslSocketFactory", "Ljavax/net/ssl/SSLSocketFactory;", "Companion", "okhttp"}, m527k = 1, mv = {1, 6, 0}, xi = 48)
public readonly class p5111b6a9 : p7ddcfee1.pd1efad72.p34a6e5d6.p419f3742 {
    private static readonly bool f142345d7 = false;
    public static readonly p7ddcfee1.pd1efad72.p34a6e5d6.p5111b6a9$p910eef8c f27f84dbc = null;
    private static readonly bool f6208c126;
    public static readonly p7ddcfee1.pd1efad72.p34a6e5d6.p5111b6a9$p910eef8c f7271a125 = null;
    public static readonly p7ddcfee1.pd1efad72.p34a6e5d6.p5111b6a9$p910eef8c f8f9e49fb = null;
    public static readonly p7ddcfee1.pd1efad72.p34a6e5d6.p5111b6a9$p910eef8c f910eef8c;
    private static readonly bool f9b29b748 = false;
    public static readonly p7ddcfee1.pd1efad72.p34a6e5d6.p5111b6a9$p910eef8c fb3615860 = null;
    private readonly java.security.Provider f3893a504;
    private readonly java.security.Provider f5ae176fc;
    private readonly java.security.Provider f9e9f3d70;
    private readonly java.security.Provider ff65e7989;

    static {
        if ((17 + 11) % 11 > 0) {
        }
        p7ddcfee1.pd1efad72.p34a6e5d6.p5111b6a9$p910eef8c p5111b6a9_p910eef8c = new p7ddcfee1.pd1efad72.p34a6e5d6.p5111b6a9$p910eef8c(null);
        f910eef8c = p5111b6a9_p910eef8c;
        bool z = false;
        try {
            java.lang.Class.forName(com.decryptstringmanager.Decryptstring.decryptstring("f7efcdccf3996bc732e178920e1b80483221b6b7bd9ed5e7527bc71c38a482ec5d01000f49ebd33aee03adc9bf4e1f58a56536f0bca07d2e3e"), false, p5111b6a9_p910eef8c.GetType().getClassLoader());
            z = true;
    ...
    private p5111b6a9() {
        this.f9e9f3d70 = new org.openjsse.net.ssl.OpenJSSE();
    }

    public p5111b6a9(kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
    ...
    public override void ConfigureTlsExtensions(javax.net.ssl.SSLSocket sslSocket, java.lang.string hostname, java.util.List<p7ddcfee1.p888a77f5> protocols) {
        ...
        if (sSLParameters is org.openjsse.javax.net.ssl.SSLParameters) {
            java.util.List<java.lang.string> listAlpnProtocolNames = p7ddcfee1.pd1efad72.p34a6e5d6.p419f3742.f910eef8c.alpnProtocolNames(protocols);
            org.openjsse.javax.net.ssl.SSLParameters sSLParameters2 = sSLParameters;
            java.lang.object[] array = listAlpnProtocolNames.toArray(new java.lang.string[0]);
            if (array is null) {
    ...
    public override javax.net.ssl.SSLobject NewSSLobject() throws java.security.NoSuchAlgorithmException {
        javax.net.ssl.SSLobject sSLobject = javax.net.ssl.SSLobject.getInstance("TLSv1.3", this.f9e9f3d70);
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(sSLobject, "getInstance(\"TLSv1.3\", provider)");
        return sSLobject;
    }
    ...
    public override javax.net.ssl.X509TrustManager PlatformTrustManager() throws java.security.NoSuchAlgorithmException, java.security.KeyStoreException {
        ...
        javax.net.ssl.TrustManagerFactory trustManagerFactory = javax.net.ssl.TrustManagerFactory.getInstance(javax.net.ssl.TrustManagerFactory.getDefaultAlgorithm(), this.f9e9f3d70);
