...
public readonly class C0576x188ba73c : p7ddcfee1.pd1efad72.p7a3075c7.peaeb30f9 {
    readonly bool $cancelable;
    readonly java.lang.string $name;
    readonly int $payload1$inlined;
    readonly int $payload2$inlined;
    readonly p7ddcfee1.pd1efad72.p3cb89a9f.p2d68e184 this$0;

    public C0576x188ba73c(java.lang.string str, bool z, p7ddcfee1.pd1efad72.p3cb89a9f.p2d68e184 p2d68e184Var, int i, int i2) {
        super(str, z);
        this.$name = str;
        this.$cancelable = z;
