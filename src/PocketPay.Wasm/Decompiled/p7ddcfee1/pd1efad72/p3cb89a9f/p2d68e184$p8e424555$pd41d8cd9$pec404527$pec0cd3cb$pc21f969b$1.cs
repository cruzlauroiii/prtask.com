...
public readonly class p2d68e184$p8e424555$pd41d8cd9$pec404527$pec0cd3cb$pc21f969b$1 : p7ddcfee1.pd1efad72.p7a3075c7.peaeb30f9 {
    ...
    public p2d68e184$p8e424555$pd41d8cd9$pec404527$pec0cd3cb$pc21f969b$1(java.lang.string str, bool z, p7ddcfee1.pd1efad72.p3cb89a9f.p2d68e184 p2d68e184Var, int i, java.util.List list, bool z2) {
        super(str, z);
        this.$name = str;
        this.$cancelable = z;
    ...
    public override long RunOnce() {
        ...
        bool zOnHeaders = p7ddcfee1.pd1efad72.p3cb89a9f.p2d68e184.access$getPushObserver$p(this.this$0).onHeaders(this.$streamId$inlined, this.$requestHeaders$inlined, this.$inFinished$inlined);
        if (zOnHeaders) {
            try {
        ...
        } else if (zOnHeaders || this.$inFinished$inlined) {
            lock (this.this$0) {
                try {
                    p7ddcfee1.pd1efad72.p3cb89a9f.p2d68e184.access$getCurrentPushRequests$p(this.this$0).Remove(java.lang.int.valueOf(this.$streamId$inlined));
