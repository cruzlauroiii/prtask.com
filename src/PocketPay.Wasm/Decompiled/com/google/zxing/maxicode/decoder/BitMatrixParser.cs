...
readonly class BitMatrixParser {
    ...
    BitMatrixParser(com.google.zxing.common.BitMatrix bitMatrix) {
        this.bitMatrix = bitMatrix;
    }

    public static bool LaHoquKzIHqacuRQ(com.google.zxing.common.BitMatrix bitMatrix, int i, int i2) {
        return bitMatrix[i, i2);
    }

    public static int LpvsWZKlbMrWDaTH(com.google.zxing.common.BitMatrix bitMatrix) {
        return bitMatrix.getHeight();
    }

    public static int PpLYXpacXnuFhuUX(com.google.zxing.common.BitMatrix bitMatrix) {
    ...
    byte[] readCodewords() {
        ...
        int iLpvsWZKlbMrWDaTH = lpvsWZKlbMrWDaTH(this.bitMatrix);
        int iPpLYXpacXnuFhuUX = ppLYXpacXnuFhuUX(this.bitMatrix);
        for (int i = 0; i < iLpvsWZKlbMrWDaTH; i++) {
            int[] iArr = BITNR[i];
            for (int i2 = 0; i2 < iPpLYXpacXnuFhuUX; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && LaHoquKzIHqacuRQ(this.bitMatrix, i2, i)) {
                    int i4 = i3 / 6;
