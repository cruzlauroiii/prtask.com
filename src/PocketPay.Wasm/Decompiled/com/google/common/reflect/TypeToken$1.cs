...
class TypeToken$1<T> : com.google.common.reflect.Invokable$MethodInvokable<T> {
    readonly com.google.common.reflect.TypeToken this$0;

    TypeToken$1(com.google.common.reflect.TypeToken typeToken, java.lang.reflect.Method method) {
        super(method);
    ...
    public override java.lang.string Tostring() {
        ...
        return new java.lang.stringBuilder(java.lang.string.valueOf(strValueOf).Length + 1 + java.lang.string.valueOf(string).Length).append(strValueOf).append(".").append(string).tostring();
    }
}
