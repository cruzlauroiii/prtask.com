...
abstract class FluentTask$TrustedTask<V> : com.google.common.util.concurrent.FluentTask<V> : com.google.common.util.concurrent.AbstractTask$Trusted<V> {
    FluentTask$TrustedTask() {
    }
