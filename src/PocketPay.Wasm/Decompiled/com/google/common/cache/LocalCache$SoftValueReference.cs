...
class LocalCache$SoftValueReference<K, V> : java.lang.ref.SoftReference<V> : com.google.common.cache.LocalCache$ValueReference<K, V> {
    readonly com.google.common.cache.ReferenceEntry<K, V> entry;

    LocalCache$SoftValueReference(java.lang.ref.ReferenceQueue<V> referenceQueue, V v, com.google.common.cache.ReferenceEntry<K, V> referenceEntry) {
