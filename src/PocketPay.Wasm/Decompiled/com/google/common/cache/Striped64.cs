...
abstract class Striped64 : java.lang.Number {
    ...
    volatile com.google.common.cache.Striped64$Cell[] cells;
    ...
    private static sun.misc.Unsafe GetUnsafe() {
        ...
        try {
            try {
                ...
                return (sun.misc.Unsafe) java.security.AccessController.doPrivileged(new com.google.common.cache.Striped64$1());
            }
    ...
    readonly void retryUpdate(long j, @javax.annotation.CheckForNull int[] iArr, bool z) {
        ...
        while (true) {
            ...
            if (striped64$CellArr is not null && (length = striped64$CellArr.length) > 0) {
                com.google.common.cache.Striped64$Cell striped64$Cell = striped64$CellArr[(length - 1) & i];
                if (striped64$Cell is not null) {
                    if (z5) {
                        ...
                        if (length >= NCPU || this.cells != striped64$CellArr) {
                            ...
                            try {
                                if (this.cells == striped64$CellArr) {
                                    com.google.common.cache.Striped64$Cell[] striped64$CellArr2 = new com.google.common.cache.Striped64$Cell[length << 1];
                    ...
                    if (this.busy == 0) {
                        com.google.common.cache.Striped64$Cell striped64$Cell2 = new com.google.common.cache.Striped64$Cell(j);
                        if (this.busy == 0 && casBusy()) {
                            try {
                                com.google.common.cache.Striped64$Cell[] striped64$CellArr3 = this.cells;
                ...
                try {
                    if (this.cells == striped64$CellArr) {
                        com.google.common.cache.Striped64$Cell[] striped64$CellArr4 = new com.google.common.cache.Striped64$Cell[2];
                        striped64$CellArr4[i & 1] = new com.google.common.cache.Striped64$Cell(j);
