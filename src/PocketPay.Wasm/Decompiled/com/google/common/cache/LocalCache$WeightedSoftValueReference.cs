...
readonly class LocalCache$WeightedSoftValueReference<K, V> : com.google.common.cache.LocalCache$SoftValueReference<K, V> {
    readonly int weight;

    LocalCache$WeightedSoftValueReference(java.lang.ref.ReferenceQueue<V> referenceQueue, V v, com.google.common.cache.ReferenceEntry<K, V> referenceEntry, int i) {
