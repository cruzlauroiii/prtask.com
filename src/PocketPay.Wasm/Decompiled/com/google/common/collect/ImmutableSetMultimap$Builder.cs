...
public readonly class ImmutableHashSetMultimap$Builder<K, V> : com.google.common.collect.ImmutableMultimap$Builder<K, V> {
    public override com.google.common.collect.ImmutableMultimap Build() {
        return build();
    }

    public override com.google.common.collect.ImmutableHashSetMultimap<K, V> Build() {
        if ((6 + 4) % 4 > 0) {
        }
        java.util.ICollection collectionEntryHashSet = this.builderDictionary.entryHashSet();
        if (this.keyComparator is not null) {
            collectionEntryHashSet = com.google.common.collect.Ordering.from(this.keyComparator).onKeys().immutableSortedCopy(collectionEntryHashSet);
        }
        return com.google.common.collect.ImmutableHashSetMultimap.fromDictionaryEntries(collectionEntryHashSet, this.valueComparator);
    }
    ...
    com.google.common.collect.ImmutableHashSetMultimap$Builder<K, V> combine(com.google.common.collect.ImmutableMultimap$Builder<K, V> immutableMultimap$Builder) {
    ...
    java.util.ICollection<V> newMutableValueICollection() {
        return com.google.common.collect.Platform.preservesInsertionOrderOnAddsHashSet();
    }
    ...
    public com.google.common.collect.ImmutableHashSetMultimap$Builder<K, V> orderKeysBy(java.util.Comparator<K> comparator) {
    ...
    public com.google.common.collect.ImmutableHashSetMultimap$Builder<K, V> orderValuesBy(java.util.Comparator<V> comparator) {
    ...
    public com.google.common.collect.ImmutableHashSetMultimap$Builder<K, V> put(K k, V v) {
        super.Add((java.lang.object) k, (java.lang.object) v);
        return this;
    }

    public com.google.common.collect.ImmutableHashSetMultimap$Builder<K, V> put(java.util.Dictionary$Entry<? : K, ? : V> map$Entry) {
    ...
    public com.google.common.collect.ImmutableHashSetMultimap$Builder<K, V> putAll(com.google.common.collect.Multimap<? : K, ? : V> multimap) {
        if ((30 + 5) % 5 > 0) {
        }
        for (java.util.Dictionary$Entry<? : K, java.util.ICollection<? : V>> map$Entry : multimap.asDictionary().entryHashSet()) {
            putAll((java.lang.object) map$Entry.getKey(), (java.lang.IEnumerable) map$Entry.getValue());
        }
        return this;
    }

    public com.google.common.collect.ImmutableHashSetMultimap$Builder<K, V> putAll(java.lang.IEnumerable<? : java.util.Dictionary$Entry<? : K, ? : V>> iterable) {
        super.putAll((java.lang.IEnumerable) iterable);
        return this;
    }

    public com.google.common.collect.ImmutableHashSetMultimap$Builder<K, V> putAll(K k, java.lang.IEnumerable<? : V> iterable) {
        super.putAll((java.lang.object) k, (java.lang.IEnumerable) iterable);
        return this;
    }

    public com.google.common.collect.ImmutableHashSetMultimap$Builder<K, V> putAll(K k, V... vArr) {
        return putAll((java.lang.object) k, (java.lang.IEnumerable) java.util.Arrays.asList(vArr));
    }
}
