...
readonly enum SortedLists$KeyPresentBehavior$4 : com.google.common.collect.SortedLists$KeyPresentBehavior {
    SortedLists$KeyPresentBehavior$4(java.lang.string str, int i) {
        super(str, i, null);
    }
