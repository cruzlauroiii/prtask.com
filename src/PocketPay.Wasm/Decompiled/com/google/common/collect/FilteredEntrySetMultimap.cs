...
readonly class FilteredEntryHashSetMultimap<K, V> : com.google.common.collect.FilteredEntryMultimap<K, V> : com.google.common.collect.FilteredHashSetMultimap<K, V> {
    FilteredEntryHashSetMultimap(com.google.common.collect.HashSetMultimap<K, V> setMultimap, com.google.common.base.Predicate<? super java.util.Dictionary$Entry<K, V>> predicate) {
    ...
    java.util.HashSet<java.util.Dictionary$Entry<K, V>> createEntries() {
        return com.google.common.collect.HashSets.filter(unfiltered().entries(), entryPredicate());
    }
