...
class Multisets$1$1<E> : com.google.common.collect.AbstractIEnumerator<com.google.common.collect.Multiset$Entry<E>> {
    readonly com.google.common.collect.Multisets$1 this$0;
    readonly java.util.IEnumerator val$iterator1;
    readonly java.util.IEnumerator val$iterator2;

    Multisets$1$1(com.google.common.collect.Multisets$1 multisets$1, java.util.IEnumerator it, java.util.IEnumerator it2) {
    ...
    protected com.google.common.collect.Multiset$Entry<E> computeNext() {
        ...
        if (this.val$iterator1.MoveNext()) {
            ...
            return com.google.common.collect.Multisets.immutableEntry(element, java.lang.Math.max(multiset$Entry.getCount(), this.this$0.val$multiset2.count(element)));
        }
