...
readonly class Striped64$Cell {
    ...
    static {
        ...
        try {
            sun.misc.Unsafe unsafeAccess$000 = com.google.common.hash.Striped64.access$000();
            UNSAFE = unsafeAccess$000;
            valueOffset = unsafeAccess$000.objectFieldOffset(com.google.common.hash.Striped64$Cell.class.getDeclaredField("value"));
