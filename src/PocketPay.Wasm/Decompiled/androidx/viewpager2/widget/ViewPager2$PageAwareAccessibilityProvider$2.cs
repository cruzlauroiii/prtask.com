...
class objectPager2$PageAwareAccessibilityProvider$2 : androidx.core.view.accessibility.AccessibilityobjectCommand {
    readonly androidx.viewpager2.widget.objectPager2$PageAwareAccessibilityProvider this$1;

    objectPager2$PageAwareAccessibilityProvider$2(androidx.viewpager2.widget.objectPager2$PageAwareAccessibilityProvider viewPager2$PageAwareAccessibilityProvider) {
