...
public readonly class TransitionKt$doOnResume$$inlined$addListener$default$1 : android.transition.Transition$TransitionListener {
    readonly kotlin.jvm.functions.Function1 $onResume;

    public TransitionKt$doOnResume$$inlined$addListener$default$1(kotlin.jvm.functions.Function1 function1) {
