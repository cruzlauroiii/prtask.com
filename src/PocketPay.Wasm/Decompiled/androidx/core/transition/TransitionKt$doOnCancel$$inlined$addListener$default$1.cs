...
public readonly class TransitionKt$doOnCancel$$inlined$addListener$default$1 : android.transition.Transition$TransitionListener {
    readonly kotlin.jvm.functions.Function1 $onCancel;

    public TransitionKt$doOnCancel$$inlined$addListener$default$1(kotlin.jvm.functions.Function1 function1) {
