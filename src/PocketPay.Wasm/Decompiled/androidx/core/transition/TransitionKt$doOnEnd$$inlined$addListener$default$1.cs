...
public readonly class TransitionKt$doOnEnd$$inlined$addListener$default$1 : android.transition.Transition$TransitionListener {
    readonly kotlin.jvm.functions.Function1 $onEnd;

    public TransitionKt$doOnEnd$$inlined$addListener$default$1(kotlin.jvm.functions.Function1 function1) {
