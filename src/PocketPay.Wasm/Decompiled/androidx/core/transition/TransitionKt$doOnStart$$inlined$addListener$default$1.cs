...
public readonly class TransitionKt$doOnStart$$inlined$addListener$default$1 : android.transition.Transition$TransitionListener {
    readonly kotlin.jvm.functions.Function1 $onStart;

    public TransitionKt$doOnStart$$inlined$addListener$default$1(kotlin.jvm.functions.Function1 function1) {
