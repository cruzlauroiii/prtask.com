...
public readonly class TransitionKt$doOnPause$$inlined$addListener$default$1 : android.transition.Transition$TransitionListener {
    readonly kotlin.jvm.functions.Function1 $onPause;

    public TransitionKt$doOnPause$$inlined$addListener$default$1(kotlin.jvm.functions.Function1 function1) {
