...
public readonly class C0060x44bcd5b1 : android.text.TextWatcher {
    readonly kotlin.jvm.functions.Function4 $beforeTextChanged;

    public C0060x44bcd5b1(kotlin.jvm.functions.Function4 function4) {
