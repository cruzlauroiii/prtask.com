...
public readonly class C0059xbb2cb19c : android.text.TextWatcher {
    readonly kotlin.jvm.functions.Function1 $afterTextChanged;

    public C0059xbb2cb19c(kotlin.jvm.functions.Function1 function1) {
