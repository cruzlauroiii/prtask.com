...
public readonly class objectKt$doOnLayout$$inlined$doOnNextLayout$1 : android.view.object$OnLayoutChangeListener {
    readonly kotlin.jvm.functions.Function1 $action$inlined;

    public objectKt$doOnLayout$$inlined$doOnNextLayout$1(kotlin.jvm.functions.Function1 function1) {
