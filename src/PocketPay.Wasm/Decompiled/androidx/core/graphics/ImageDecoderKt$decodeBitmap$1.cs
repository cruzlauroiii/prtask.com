...
public readonly class ImageDecoderKt$decodeBitmap$1 : android.graphics.ImageDecoder$OnHeaderDecodedListener {
    ...
    public ImageDecoderKt$decodeBitmap$1(kotlin.jvm.functions.Function3<? super android.graphics.ImageDecoder, ? super android.graphics.ImageDecoder$ImageInfo, ? super android.graphics.ImageDecoder$Source, kotlin.Unit> function3) {
