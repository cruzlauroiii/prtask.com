...
class TypefaceCompatBaseImpl$2 : androidx.core.graphics.TypefaceCompatBaseImpl$StyleExtractor<androidx.core.content.res.FontResourcesParserCompat$FontstringResourceEntry> {
    readonly androidx.core.graphics.TypefaceCompatBaseImpl this$0;

    TypefaceCompatBaseImpl$2(androidx.core.graphics.TypefaceCompatBaseImpl typefaceCompatBaseImpl) {
