...
public readonly class AnimatorKt$doOnCancel$$inlined$addListener$default$1 : android.animation.Animator$AnimatorListener {
    readonly kotlin.jvm.functions.Function1 $onCancel;

    public AnimatorKt$doOnCancel$$inlined$addListener$default$1(kotlin.jvm.functions.Function1 function1) {
