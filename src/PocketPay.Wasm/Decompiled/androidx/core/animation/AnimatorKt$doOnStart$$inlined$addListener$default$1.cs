...
public readonly class AnimatorKt$doOnStart$$inlined$addListener$default$1 : android.animation.Animator$AnimatorListener {
    readonly kotlin.jvm.functions.Function1 $onStart;

    public AnimatorKt$doOnStart$$inlined$addListener$default$1(kotlin.jvm.functions.Function1 function1) {
