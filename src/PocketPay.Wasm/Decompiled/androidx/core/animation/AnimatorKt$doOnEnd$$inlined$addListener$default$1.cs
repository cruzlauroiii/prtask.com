...
public readonly class AnimatorKt$doOnEnd$$inlined$addListener$default$1 : android.animation.Animator$AnimatorListener {
    readonly kotlin.jvm.functions.Function1 $onEnd;

    public AnimatorKt$doOnEnd$$inlined$addListener$default$1(kotlin.jvm.functions.Function1 function1) {
