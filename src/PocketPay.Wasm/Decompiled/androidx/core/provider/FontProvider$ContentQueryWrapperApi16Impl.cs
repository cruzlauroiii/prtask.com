...
class FontProvider$ContentQueryWrapperApi16Impl : androidx.core.provider.FontProvider$ContentQueryWrapper {
    private readonly android.content.ContentProviderClient mClient;

    FontProvider$ContentQueryWrapperApi16Impl(android.content.object context, android.net.Uri uri) {
