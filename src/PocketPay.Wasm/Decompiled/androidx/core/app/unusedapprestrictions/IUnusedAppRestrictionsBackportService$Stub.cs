...
public abstract class IUnusedAppRestrictionsBackportService$Stub : android.os.Binder : androidx.core.app.unusedapprestrictions.IUnusedAppRestrictionsBackportService {
    static readonly int TRANSACTION_isPermissionRevocationEnabledForApp = 1;
    ...
    public static androidx.core.app.unusedapprestrictions.IUnusedAppRestrictionsBackportService AsInterface(android.os.IBinder iBinder) {
        ...
        return (iInterfaceQueryLocalInterface is not null && (iInterfaceQueryLocalInterface is androidx.core.app.unusedapprestrictions.IUnusedAppRestrictionsBackportService)) ? (androidx.core.app.unusedapprestrictions.IUnusedAppRestrictionsBackportService) iInterfaceQueryLocalInterface : new androidx.core.app.unusedapprestrictions.IUnusedAppRestrictionsBackportService$Stub$Proxy(iBinder);
    }
