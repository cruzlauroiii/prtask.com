...
readonly class C0189x106d7262 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<androidx.sqlite.db.SupportSQLiteDatabase, java.lang.object> {
    readonly java.lang.object[] $bindArgs;
    readonly java.lang.string $sql;

    C0189x106d7262(java.lang.string str, java.lang.object[] objArr) {
        super(1);
        this.$sql = str;
