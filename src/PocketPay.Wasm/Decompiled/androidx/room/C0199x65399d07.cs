...
readonly class C0199x65399d07 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<androidx.sqlite.db.SupportSQLiteDatabase, java.lang.object> {
    readonly long $numbytes;

    C0199x65399d07(long j) {
        super(1);
        this.$numbytes = j;
    }
