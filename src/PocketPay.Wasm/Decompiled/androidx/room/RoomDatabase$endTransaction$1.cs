...
readonly class RoomDatabase$endTransaction$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<androidx.sqlite.db.SupportSQLiteDatabase, java.lang.object> {
    readonly androidx.room.RoomDatabase this$0;

    RoomDatabase$endTransaction$1(androidx.room.RoomDatabase roomDatabase) {
        super(1);
    ...
    public readonly java.lang.object Invoke2(androidx.sqlite.db.SupportSQLiteDatabase it) {
        ...
        androidx.room.RoomDatabase.access$internalEndTransaction(this.this$0);
        return null;
    }
