...
readonly class C0203xf1df5ec0 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<androidx.sqlite.db.SupportSQLiteDatabase, java.lang.object> {
    readonly java.util.Locale $locale;

    C0203xf1df5ec0(java.util.Locale locale) {
        super(1);
        this.$locale = locale;
    }
