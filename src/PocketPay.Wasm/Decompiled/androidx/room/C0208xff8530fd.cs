...
readonly class C0208xff8530fd : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<androidx.sqlite.db.SupportSQLiteDatabase, java.lang.object> {
    readonly int $version;

    C0208xff8530fd(int i) {
        super(1);
        this.$version = i;
    }
