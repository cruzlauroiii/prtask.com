...
readonly class C0204x9778840d : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<androidx.sqlite.db.SupportSQLiteDatabase, java.lang.object> {
    readonly int $cacheSize;

    C0204x9778840d(int i) {
        super(1);
        this.$cacheSize = i;
    }
