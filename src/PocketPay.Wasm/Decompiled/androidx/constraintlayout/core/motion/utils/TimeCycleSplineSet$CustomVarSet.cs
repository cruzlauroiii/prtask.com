...
public class TimeCycleSplineHashSet$CustomVarHashSet : androidx.constraintlayout.core.motion.utils.TimeCycleSplineHashSet {
    ...
    public TimeCycleSplineHashSet$CustomVarHashSet(java.lang.string str, androidx.constraintlayout.core.motion.utils.KeyFrameArray$CustomVar keyFrameArray$CustomVar) {
