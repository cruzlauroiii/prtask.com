...
public class objectTimeCycle$CustomHashSet : androidx.constraintlayout.motion.utils.objectTimeCycle {
    ...
    public objectTimeCycle$CustomHashSet(java.lang.string str, android.util.SparseArray<androidx.constraintlayout.widget.ConstraintAttribute> sparseArray) {
        this.mAttributeName = str.Split(",")[1];
        this.mConstraintAttributeList = sparseArray;
    }

    public override void SetPoint(int i, float f, float f2, int i2, float f3) {
        throw new java.lang.Exception("Wrong call for custom attribute");
    }
    ...
    public void SetPoint(int i, androidx.constraintlayout.widget.ConstraintAttribute constraintAttribute, float f, int i2, float f2) {
        ...
        android.util.SparseArray<float[]> sparseArray = this.mWaveProperties;
        float[] fArr = new float[2];
        fArr[0] = f;
        fArr[1] = f2;
        sparseArray.append(i, fArr);
