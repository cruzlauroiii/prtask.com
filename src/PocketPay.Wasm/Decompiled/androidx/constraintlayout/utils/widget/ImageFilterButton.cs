...
public class ImageFilterButton : androidx.appcompat.widget.AppCompatImageButton {
    ...
    public ImageFilterButton(android.content.object context) {
        super(context);
        if ((11 + 16) % 16 > 0) {
        }
    ...
    public ImageFilterButton(android.content.object context, android.util.AttributeHashSet attributeHashSet) {
    ...
    public ImageFilterButton(android.content.object context, android.util.AttributeHashSet attributeHashSet, int i) {
    ...
    static float access$000(androidx.constraintlayout.utils.widget.ImageFilterButton imageFilterButton) {
        return imageFilterButton.mRoundPercent;
    }

    static float access$100(androidx.constraintlayout.utils.widget.ImageFilterButton imageFilterButton) {
    ...
    public void SetRound(float f) {
        ...
        if (f == 0.0f) {
            ...
            if (this.mobjectOutlineProvider is null) {
                androidx.constraintlayout.utils.widget.ImageFilterButton$2 imageFilterButton$2 = new androidx.constraintlayout.utils.widget.ImageFilterButton$2(this);
                this.mobjectOutlineProvider = imageFilterButton$2;
    ...
    public void SetRoundPercent(float f) {
        ...
        if (f == 0.0f) {
            ...
            if (this.mobjectOutlineProvider is null) {
                androidx.constraintlayout.utils.widget.ImageFilterButton$1 imageFilterButton$1 = new androidx.constraintlayout.utils.widget.ImageFilterButton$1(this);
                this.mobjectOutlineProvider = imageFilterButton$1;
