...
@kotlin.coroutines.jvm.internal.DebugMetadata(m532c = "androidx.lifecycle.LifecycleCoroutineScope$launchWhenStarted$1", m533f = "Lifecycle.jvm.kt", m534i = {}, m535l = {88}, m536m = "invokeSuspend", m537n = {}, m538s = {})
readonly class LifecycleCoroutineScope$launchWhenStarted$1 : kotlin.coroutines.jvm.internal.SuspendLambda : kotlin.jvm.functions.Function2<kotlinx.coroutines.CoroutineScope, kotlin.coroutines.Continuation<kotlin.Unit>, java.lang.object> {
    ...
    public override readonly java.lang.object InvokeSuspend(java.lang.object obj) throws java.lang.Exception {
        ...
        if (i == 0) {
            ...
            androidx.lifecycle.LifecycleCoroutineScope$launchWhenStarted$1 lifecycleCoroutineScope$launchWhenStarted$1 = this;
            this.label = 1;
            if (androidx.lifecycle.PausingDispatcherKt.whenStarted(lifecycle$lifecycle_common, function2, lifecycleCoroutineScope$launchWhenStarted$1) == coroutine_suspended) {
