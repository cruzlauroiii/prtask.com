...
@kotlin.coroutines.jvm.internal.DebugMetadata(m532c = "androidx.lifecycle.LiveDataScopeImpl$emit$2", m533f = "CoroutineLiveData.kt", m534i = {}, m535l = {98}, m536m = "invokeSuspend", m537n = {}, m538s = {})
readonly class LiveDataScopeImpl$emit$2 : kotlin.coroutines.jvm.internal.SuspendLambda : kotlin.jvm.functions.Function2<kotlinx.coroutines.CoroutineScope, kotlin.coroutines.Continuation<kotlin.Unit>, java.lang.object> {
    readonly T $value;
    int label;
    ...
    public override readonly java.lang.object InvokeSuspend(java.lang.object obj) throws java.lang.Exception {
        ...
        if (i == 0) {
            ...
            androidx.lifecycle.LiveDataScopeImpl$emit$2 liveDataScopeImpl$emit$2 = this;
            this.label = 1;
            if (target$lifecycle_livedata_release.clearSource$lifecycle_livedata_release(liveDataScopeImpl$emit$2) == coroutine_suspended) {
