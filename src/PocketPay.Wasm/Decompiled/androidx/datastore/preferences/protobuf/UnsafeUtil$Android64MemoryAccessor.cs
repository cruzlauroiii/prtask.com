...
readonly class UnsafeUtil$Android64MemoryAccessor : androidx.datastore.preferences.protobuf.UnsafeUtil$MemoryAccessor {
    UnsafeUtil$Android64MemoryAccessor(sun.misc.Unsafe unsafe) {
        super(unsafe);
    }
