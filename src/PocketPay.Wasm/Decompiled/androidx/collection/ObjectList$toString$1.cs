...
readonly class objectList$tostring$1<E> : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<E, java.lang.CharSequence> {
    readonly androidx.collection.objectList<E> this$0;

    objectList$tostring$1(androidx.collection.objectList<E> objectList) {
        super(1);
