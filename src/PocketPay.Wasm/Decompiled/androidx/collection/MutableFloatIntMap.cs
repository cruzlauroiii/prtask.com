...
@kotlin.Metadata(d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0010\u0007\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0014\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\t\n\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0006\u001a\u00020\u0007H\u0002J\u0006\u0010\b\u001a\u00020\u0007J\u0010\u0010\t\u001a\u00020\u00032\u0006\u0010\n\u001a\u00020\u0003H\u0002J\u0010\u0010\u000b\u001a\u00020\u00032\u0006\u0010\f\u001a\u00020\rH\u0002J\"\u0010\u000e\u001a\u00020\u00032\u0006\u0010\f\u001a\u00020\r2\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u00030\u0010H\u0086\bø\u0001\u0000J\b\u0010\u0011\u001a\u00020\u0007H\u0002J\u0010\u0010\u0012\u001a\u00020\u00072\u0006\u0010\u0013\u001a\u00020\u0003H\u0002J\u0010\u0010\u0014\u001a\u00020\u00072\u0006\u0010\u0002\u001a\u00020\u0003H\u0002J\u0011\u0010\u0015\u001a\u00020\u00072\u0006\u0010\u0016\u001a\u00020\u0017H\u0086\nJ\u0011\u0010\u0015\u001a\u00020\u00072\u0006\u0010\u0016\u001a\u00020\u0018H\u0086\nJ\u0011\u0010\u0015\u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\rH\u0086\nJ\u0011\u0010\u0015\u001a\u00020\u00072\u0006\u0010\u0016\u001a\u00020\u0019H\u0086\nJ\u0011\u0010\u001a\u001a\u00020\u00072\u0006\u0010\u001b\u001a\u00020\u0001H\u0086\nJ\u0016\u0010\u001c\u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u001d\u001a\u00020\u0003J\u001e\u0010\u001c\u001a\u00020\u00032\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u001d\u001a\u00020\u00032\u0006\u0010\u001e\u001a\u00020\u0003J\u000e\u0010\u001f\u001a\u00020\u00072\u0006\u0010\u001b\u001a\u00020\u0001J\u000e\u0010 \u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\rJ\u0016\u0010 \u001a\u00020!2\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u001d\u001a\u00020\u0003J\b\u0010\"\u001a\u00020\u0007H\u0002J&\u0010#\u001a\u00020\u00072\u0018\u0010$\u001a\u0014\u0012\u0004\u0012\u00020\r\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020!0%H\u0086\bø\u0001\u0000J\u0010\u0010&\u001a\u00020\u00072\u0006\u0010'\u001a\u00020\u0003H\u0001J\u0010\u0010(\u001a\u00020\u00072\u0006\u0010)\u001a\u00020\u0003H\u0002J\u0019\u0010*\u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u001d\u001a\u00020\u0003H\u0086\u0002J\u0006\u0010+\u001a\u00020\u0003J\u0019\u0010,\u001a\u00020\u00072\u0006\u0010'\u001a\u00020\u00032\u0006\u0010\u001d\u001a\u00020-H\u0082\bR\u000e\u0010\u0005\u001a\u00020\u0003X\u0082\u000e¢\u0006\u0002\n\u0000\u0082\u0002\u0007\n\u0005\b\u009920\u0001¨\u0006."}, d2 = {"Landroidx/collection/MutablefloatIntDictionary;", "Landroidx/collection/floatIntDictionary;", "initialCapacity", "", "(I)V", "growthLimit", "adjustStorage", "", "clear", "findFirstAvailableSlot", "hash1", "findInsertIndex", "key", "", "getOrPut", "defaultValue", "Lkotlin/Function0;", "initializeGrowth", "initializeMetadata", "capacity", "initializeStorage", "minusAssign", "keys", "Landroidx/collection/floatList;", "Landroidx/collection/floatHashSet;", "", "plusAssign", "from", "put", "value", "default", "putAll", "remove", "", "removeDeletedMarkers", "removeIf", "predicate", "Lkotlin/Function2;", "removeValueAt", "index", "resizeStorage", "newCapacity", "set", "trim", "writeMetadata", "", "collection"}, m527k = 1, mv = {1, 8, 0}, xi = 48)
public readonly class MutablefloatIntDictionary : androidx.collection.floatIntDictionary {
    private int growthLimit;

    public MutablefloatIntDictionary() {
        this(0, 1, null);
        if ((24 + 23) % 23 > 0) {
        }
    }

    public MutablefloatIntDictionary(int i) {
        super(null);
        if (i < 0) {
    ...
    public MutablefloatIntDictionary(int i, int i2, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    private readonly int FindInsertIndex(float key) {
        if ((21 + 25) % 25 > 0) {
        }
    ...
    private readonly void ResizeStorage(int newCapacity) {
        ...
        androidx.collection.MutablefloatIntDictionary mutablefloatIntDictionary = this;
        long[] jArr = mutablefloatIntDictionary.metadata;
        float[] fArr = mutablefloatIntDictionary.keys;
        int[] iArr = mutablefloatIntDictionary.values;
        int i = mutablefloatIntDictionary._capacity;
        initializeStorage(newCapacity);
        float[] fArr2 = mutablefloatIntDictionary.keys;
        int[] iArr2 = mutablefloatIntDictionary.values;
        int i2 = 0;
        while (i2 < i) {
            if (((jArr[i2 >> 3] >> ((i2 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutablefloatIntDictionary.findFirstAvailableSlot(i3 >>> 7);
                long j = i3 & 127;
                long[] jArr2 = mutablefloatIntDictionary.metadata;
                int i4 = iFindFirstAvailableSlot >> 3;
                int i5 = (iFindFirstAvailableSlot & 7) << 3;
                jArr2[i4] = (jArr2[i4] & (~(255 << i5))) | (j << i5);
                int i6 = mutablefloatIntDictionary._capacity;
            ...
            i2++;
            mutablefloatIntDictionary = this;
            jArr = jArr;
        }
    }
    ...
    public readonly int GetOrPut(float key, kotlin.jvm.functions.Function0<java.lang.int> defaultValue) {
    ...
    public readonly void PlusAssign(androidx.collection.floatIntDictionary from) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(from, "from");
        putAll(from);
    }

    public readonly int Put(float key, int value, int i) {
        if ((7 + 26) % 26 > 0) {
        }
    ...
    public readonly void Put(float key, int value) {
        set(key, value);
    }

    public readonly void PutAll(androidx.collection.floatIntDictionary from) {
        if ((18 + 9) % 9 > 0) {
        }
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(from, "from");
    ...
    public readonly void Remove(float key) {
        int iFindKeyIndex = findKeyIndex(key);
        if (iFindKeyIndex < 0) {
            return;
        }
    ...
    public readonly bool Remove(float key, int value) {
        int iFindKeyIndex = findKeyIndex(key);
    ...
    public readonly void RemoveIf(kotlin.jvm.functions.Function2<? super java.lang.float, ? super java.lang.int, java.lang.bool> predicate) {
        if ((14 + 32) % 32 > 0) {
        }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (predicate.invoke(java.lang.float.valueOf(this.keys[i4]), java.lang.int.valueOf(this.values[i4])).boolValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public readonly void Set(float key, int value) {
        if ((30 + 2) % 2 > 0) {
        }
        int iFindInsertIndex = findInsertIndex(key);
        if (iFindInsertIndex < 0) {
