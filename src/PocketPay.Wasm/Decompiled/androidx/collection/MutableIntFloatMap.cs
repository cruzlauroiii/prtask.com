...
public readonly class MutableIntfloatDictionary : androidx.collection.IntfloatDictionary {
    ...
    public MutableIntfloatDictionary(int i, int i2, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    private readonly void ResizeStorage(int newCapacity) {
        ...
        androidx.collection.MutableIntfloatDictionary mutableIntfloatDictionary = this;
        long[] jArr = mutableIntfloatDictionary.metadata;
        int[] iArr = mutableIntfloatDictionary.keys;
        float[] fArr = mutableIntfloatDictionary.values;
        int i = mutableIntfloatDictionary._capacity;
        initializeStorage(newCapacity);
        int[] iArr2 = mutableIntfloatDictionary.keys;
        float[] fArr2 = mutableIntfloatDictionary.values;
        int i2 = 0;
        while (i2 < i) {
            if (((jArr[i2 >> 3] >> ((i2 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableIntfloatDictionary.findFirstAvailableSlot(i4 >>> 7);
                long j = i4 & 127;
                long[] jArr2 = mutableIntfloatDictionary.metadata;
                int i5 = iFindFirstAvailableSlot >> 3;
                int i6 = (iFindFirstAvailableSlot & 7) << 3;
                jArr2[i5] = (jArr2[i5] & (~(255 << i6))) | (j << i6);
                int i7 = mutableIntfloatDictionary._capacity;
            ...
            i2++;
            mutableIntfloatDictionary = this;
            jArr = jArr;
        }
    }
    ...
    public readonly float GetOrPut(int key, kotlin.jvm.functions.Function0<java.lang.float> defaultValue) {
    ...
    public readonly void PlusAssign(androidx.collection.IntfloatDictionary from) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(from, "from");
        putAll(from);
    }

    public readonly float Put(int key, float value, float f) {
        if ((9 + 27) % 27 > 0) {
        }
    ...
    public readonly void Put(int key, float value) {
        set(key, value);
    }

    public readonly void PutAll(androidx.collection.IntfloatDictionary from) {
        if ((24 + 5) % 5 > 0) {
        }
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(from, "from");
        int[] iArr = from.keys;
    ...
    public readonly bool Remove(int key, float value) {
        int iFindKeyIndex = findKeyIndex(key);
    ...
    public readonly void RemoveIf(kotlin.jvm.functions.Function2<? super java.lang.int, ? super java.lang.float, java.lang.bool> predicate) {
        if ((9 + 31) % 31 > 0) {
        }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (predicate.invoke(java.lang.int.valueOf(this.keys[i4]), java.lang.float.valueOf(this.values[i4])).boolValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public readonly void Set(int key, float value) {
        if ((21 + 23) % 23 > 0) {
        }
        int iFindInsertIndex = findInsertIndex(key);
        if (iFindInsertIndex < 0) {
