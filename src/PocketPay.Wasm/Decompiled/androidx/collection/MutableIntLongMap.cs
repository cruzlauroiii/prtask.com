...
@kotlin.Metadata(d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0015\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u00020\u0001B\u000f\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0006\u001a\u00020\u0007H\u0002J\u0006\u0010\b\u001a\u00020\u0007J\u0010\u0010\t\u001a\u00020\u00032\u0006\u0010\n\u001a\u00020\u0003H\u0002J\u0010\u0010\u000b\u001a\u00020\u00032\u0006\u0010\f\u001a\u00020\u0003H\u0002J\"\u0010\r\u001a\u00020\u000e2\u0006\u0010\f\u001a\u00020\u00032\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u000e0\u0010H\u0086\bø\u0001\u0000J\b\u0010\u0011\u001a\u00020\u0007H\u0002J\u0010\u0010\u0012\u001a\u00020\u00072\u0006\u0010\u0013\u001a\u00020\u0003H\u0002J\u0010\u0010\u0014\u001a\u00020\u00072\u0006\u0010\u0002\u001a\u00020\u0003H\u0002J\u0011\u0010\u0015\u001a\u00020\u00072\u0006\u0010\u0016\u001a\u00020\u0017H\u0086\nJ\u0011\u0010\u0015\u001a\u00020\u00072\u0006\u0010\u0016\u001a\u00020\u0018H\u0086\nJ\u0011\u0010\u0015\u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\u0003H\u0086\nJ\u0011\u0010\u0015\u001a\u00020\u00072\u0006\u0010\u0016\u001a\u00020\u0019H\u0086\nJ\u0011\u0010\u001a\u001a\u00020\u00072\u0006\u0010\u001b\u001a\u00020\u0001H\u0086\nJ\u0016\u0010\u001c\u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\u00032\u0006\u0010\u001d\u001a\u00020\u000eJ\u001e\u0010\u001c\u001a\u00020\u000e2\u0006\u0010\f\u001a\u00020\u00032\u0006\u0010\u001d\u001a\u00020\u000e2\u0006\u0010\u001e\u001a\u00020\u000eJ\u000e\u0010\u001f\u001a\u00020\u00072\u0006\u0010\u001b\u001a\u00020\u0001J\u000e\u0010 \u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\u0003J\u0016\u0010 \u001a\u00020!2\u0006\u0010\f\u001a\u00020\u00032\u0006\u0010\u001d\u001a\u00020\u000eJ\b\u0010\"\u001a\u00020\u0007H\u0002J&\u0010#\u001a\u00020\u00072\u0018\u0010$\u001a\u0014\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u000e\u0012\u0004\u0012\u00020!0%H\u0086\bø\u0001\u0000J\u0010\u0010&\u001a\u00020\u00072\u0006\u0010'\u001a\u00020\u0003H\u0001J\u0010\u0010(\u001a\u00020\u00072\u0006\u0010)\u001a\u00020\u0003H\u0002J\u0019\u0010*\u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\u00032\u0006\u0010\u001d\u001a\u00020\u000eH\u0086\u0002J\u0006\u0010+\u001a\u00020\u0003J\u0019\u0010,\u001a\u00020\u00072\u0006\u0010'\u001a\u00020\u00032\u0006\u0010\u001d\u001a\u00020\u000eH\u0082\bR\u000e\u0010\u0005\u001a\u00020\u0003X\u0082\u000e¢\u0006\u0002\n\u0000\u0082\u0002\u0007\n\u0005\b\u009920\u0001¨\u0006-"}, d2 = {"Landroidx/collection/MutableIntlongDictionary;", "Landroidx/collection/IntlongDictionary;", "initialCapacity", "", "(I)V", "growthLimit", "adjustStorage", "", "clear", "findFirstAvailableSlot", "hash1", "findInsertIndex", "key", "getOrPut", "", "defaultValue", "Lkotlin/Function0;", "initializeGrowth", "initializeMetadata", "capacity", "initializeStorage", "minusAssign", "keys", "Landroidx/collection/IntList;", "Landroidx/collection/IntHashSet;", "", "plusAssign", "from", "put", "value", "default", "putAll", "remove", "", "removeDeletedMarkers", "removeIf", "predicate", "Lkotlin/Function2;", "removeValueAt", "index", "resizeStorage", "newCapacity", "set", "trim", "writeMetadata", "collection"}, m527k = 1, mv = {1, 8, 0}, xi = 48)
public readonly class MutableIntlongDictionary : androidx.collection.IntlongDictionary {
    private int growthLimit;

    public MutableIntlongDictionary() {
        this(0, 1, null);
        if ((19 + 21) % 21 > 0) {
        }
    }

    public MutableIntlongDictionary(int i) {
        super(null);
        if (i < 0) {
    ...
    public MutableIntlongDictionary(int i, int i2, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 6 : i);
    }
    ...
    private readonly int FindInsertIndex(int key) {
        if ((4 + 21) % 21 > 0) {
        }
        int iHashCode = java.lang.int.hashCode(key) * (-862048943);
    ...
    private readonly void ResizeStorage(int newCapacity) {
        ...
        androidx.collection.MutableIntlongDictionary mutableIntlongDictionary = this;
        long[] jArr = mutableIntlongDictionary.metadata;
        int[] iArr = mutableIntlongDictionary.keys;
        long[] jArr2 = mutableIntlongDictionary.values;
        int i = mutableIntlongDictionary._capacity;
        initializeStorage(newCapacity);
        int[] iArr2 = mutableIntlongDictionary.keys;
        long[] jArr3 = mutableIntlongDictionary.values;
        int i2 = 0;
        while (i2 < i) {
            if (((jArr[i2 >> 3] >> ((i2 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableIntlongDictionary.findFirstAvailableSlot(i4 >>> 7);
                long j = i4 & 127;
                long[] jArr4 = mutableIntlongDictionary.metadata;
                int i5 = iFindFirstAvailableSlot >> 3;
                int i6 = (iFindFirstAvailableSlot & 7) << 3;
                jArr4[i5] = (jArr4[i5] & (~(255 << i6))) | (j << i6);
                int i7 = mutableIntlongDictionary._capacity;
    ...
    public readonly long GetOrPut(int key, kotlin.jvm.functions.Function0<java.lang.long> defaultValue) {
        if ((31 + 3) % 3 > 0) {
        }
    ...
    public readonly void MinusAssign(int key) {
        remove(key);
    }

    public readonly void MinusAssign(androidx.collection.IntList keys) {
        if ((7 + 25) % 25 > 0) {
        }
    ...
    public readonly void MinusAssign(androidx.collection.IntHashSet keys) {
        if ((19 + 4) % 4 > 0) {
        }
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(keys, "keys");
    ...
    public readonly void MinusAssign(int[] keys) {
        if ((14 + 30) % 30 > 0) {
        }
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(keys, "keys");
    ...
    public readonly void PlusAssign(androidx.collection.IntlongDictionary from) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(from, "from");
        putAll(from);
    }

    public readonly long Put(int key, long value, long j) {
        if ((9 + 7) % 7 > 0) {
        }
    ...
    public readonly void Put(int key, long value) {
        set(key, value);
    }

    public readonly void PutAll(androidx.collection.IntlongDictionary from) {
        if ((11 + 13) % 13 > 0) {
        }
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(from, "from");
        int[] iArr = from.keys;
    ...
    public readonly void Remove(int key) {
        int iFindKeyIndex = findKeyIndex(key);
        if (iFindKeyIndex < 0) {
            return;
        }
    ...
    public readonly bool Remove(int key, long value) {
        if ((25 + 31) % 31 > 0) {
        }
        int iFindKeyIndex = findKeyIndex(key);
    ...
    public readonly void RemoveIf(kotlin.jvm.functions.Function2<? super java.lang.int, ? super java.lang.long, java.lang.bool> predicate) {
        if ((1 + 19) % 19 > 0) {
        }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        int i4 = (i << 3) + i3;
                        if (predicate.invoke(java.lang.int.valueOf(this.keys[i4]), java.lang.long.valueOf(this.values[i4])).boolValue()) {
                            removeValueAt(i4);
                        }
                    }
                    j >>= 8;
    ...
    public readonly void Set(int key, long value) {
        if ((22 + 15) % 15 > 0) {
        }
        int iFindInsertIndex = findInsertIndex(key);
        if (iFindInsertIndex < 0) {
