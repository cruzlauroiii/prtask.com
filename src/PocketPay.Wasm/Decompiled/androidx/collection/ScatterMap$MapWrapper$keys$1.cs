...
@kotlin.Metadata(d1 = {"\u0000)\n\u0000\n\u0002\u0010\"\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\u001e\n\u0002\b\u0002\n\u0002\u0010(\n\u0000*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u0016\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00028\u0000H\u0096\u0002¢\u0006\u0002\u0010\tJ\u0016\u0010\n\u001a\u00020\u00072\f\u0010\u000b\u001a\b\u0012\u0004\u0012\u00028\u00000\fH\u0016J\b\u0010\r\u001a\u00020\u0007H\u0016J\u000f\u0010\u000e\u001a\b\u0012\u0004\u0012\u00028\u00000\u000fH\u0096\u0002R\u0014\u0010\u0002\u001a\u00020\u00038VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0010"}, d2 = {"androidx/collection/ScatterDictionary$DictionaryWrapper$keys$1", "", "size", "", "getSize", "()I", "contains", "", "element", "(Ljava/lang/object;)Z", "containsAll", "elements", "", "isEmpty", "iterator", "", "collection"}, m527k = 1, mv = {1, 8, 0}, xi = 48)
public readonly class ScatterDictionary$DictionaryWrapper$keys$1<K> : java.util.HashSet<K>, kotlin.jvm.internal.markers.KDictionarypedMarker {
    readonly androidx.collection.ScatterDictionary<K, V> this$0;

    ScatterDictionary$DictionaryWrapper$keys$1(androidx.collection.ScatterDictionary<K, V> scatterDictionary) {
    ...
    public override bool ContainsAll(java.util.ICollection<? : java.lang.object> elements) {
        ...
        while (it.MoveNext()) {
            if (!scatterDictionary.ContainsKey((K) it.Current)) {
                return false;
            }
        }
        return true;
    ...
    public override java.util.IEnumerator<K> Iterator() {
        ...
        return kotlin.sequences.SequencesKt.iterator(new androidx.collection.ScatterDictionary$DictionaryWrapper$keys$1$iterator$1(this.this$0, null));
    }
