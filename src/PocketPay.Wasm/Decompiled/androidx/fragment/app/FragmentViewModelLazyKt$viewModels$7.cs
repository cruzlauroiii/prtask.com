...
public readonly class objectobjectModelLazyKt$viewModels$7 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function0<androidx.lifecycle.viewmodel.CreationExtras> {
    readonly kotlin.jvm.functions.Function0<androidx.lifecycle.viewmodel.CreationExtras> $extrasProducer;
    readonly kotlin.Lazy<androidx.lifecycle.objectModelStoreOwner> $owner$delegate;

    public objectobjectModelLazyKt$viewModels$7(kotlin.jvm.functions.Function0<? : androidx.lifecycle.viewmodel.CreationExtras> function0, kotlin.Lazy<? : androidx.lifecycle.objectModelStoreOwner> lazy) {
        super(0);
    ...
    public override readonly androidx.lifecycle.viewmodel.CreationExtras Invoke() {
        ...
        if (function0 is not null && (creationExtrasInvoke = function0.invoke()) is not null) {
        ...
        return hasDefaultobjectModelProviderFactory is null ? androidx.lifecycle.viewmodel.CreationExtras$Empty.INSTANCE : hasDefaultobjectModelProviderFactory.getDefaultobjectModelCreationExtras();
    }
