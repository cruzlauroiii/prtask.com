...
public readonly class objectobjectModelLazyKt$viewModels$owner$4 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function0<androidx.lifecycle.objectModelStoreOwner> {
    readonly kotlin.jvm.functions.Function0<androidx.lifecycle.objectModelStoreOwner> $ownerProducer;

    public objectobjectModelLazyKt$viewModels$owner$4(kotlin.jvm.functions.Function0<? : androidx.lifecycle.objectModelStoreOwner> function0) {
        super(0);
