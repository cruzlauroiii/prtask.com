...
class objectManager$RestoreBackStackState : androidx.fragment.app.objectManager$OpGenerator {
    private readonly java.lang.string mName;
    readonly androidx.fragment.app.objectManager this$0;

    objectManager$RestoreBackStackState(androidx.fragment.app.objectManager fragmentManager, java.lang.string str) {
