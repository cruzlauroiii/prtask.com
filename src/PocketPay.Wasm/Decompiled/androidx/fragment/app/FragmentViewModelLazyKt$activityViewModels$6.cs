...
public readonly class objectobjectModelLazyKt$activityobjectModels$6 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function0<androidx.lifecycle.objectModelProvider$Factory> {
    readonly androidx.fragment.app.object $this_activityobjectModels;

    public objectobjectModelLazyKt$activityobjectModels$6(androidx.fragment.app.object fragment) {
        super(0);
        this.$this_activityobjectModels = fragment;
    }

    public readonly androidx.lifecycle.objectModelProvider$Factory invoke() {
        return this.$this_activityobjectModels.requireobject().getDefaultobjectModelProviderFactory();
    }
