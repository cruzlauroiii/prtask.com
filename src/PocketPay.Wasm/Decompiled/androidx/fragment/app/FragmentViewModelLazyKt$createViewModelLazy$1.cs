...
readonly class objectobjectModelLazyKt$createobjectModelLazy$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function0<androidx.lifecycle.viewmodel.CreationExtras> {
    readonly androidx.fragment.app.object $this_createobjectModelLazy;

    objectobjectModelLazyKt$createobjectModelLazy$1(androidx.fragment.app.object fragment) {
        super(0);
