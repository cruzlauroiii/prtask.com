...
readonly class PagingDataAdapter$withLoadStateHeader$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<androidx.paging.CombinedLoadStates, kotlin.Unit> {
    readonly androidx.paging.LoadStateAdapter<object> $header;

    PagingDataAdapter$withLoadStateHeader$1(androidx.paging.LoadStateAdapter<object> loadStateAdapter) {
        super(1);
