...
public readonly class C0146x463405a5<R> : kotlinx.coroutines.flow.Flow<androidx.paging.PageEvent<R>> {
    ...
    public C0146x463405a5(kotlinx.coroutines.flow.Flow flow, kotlin.jvm.functions.Function2 function2) {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        ...
        java.lang.object objCollect = this.$this_unsafeTransform$inlined.collect(new androidx.paging.C0148x894934f3(flowCollector, this.$transform$inlined), continuation);
    ...
    public java.lang.object collect$$forInline(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        ...
        new androidx.paging.C0147x894934f2(this, continuation);
        this.$this_unsafeTransform$inlined.collect(new androidx.paging.C0148x894934f3(flowCollector, this.$transform$inlined), continuation);
