...
readonly class PagedList$removeWeakCallback$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<java.lang.ref.WeakReference<androidx.paging.PagedList$Callback>, java.lang.bool> {
    readonly androidx.paging.PagedList$Callback $callback;

    PagedList$removeWeakCallback$1(androidx.paging.PagedList$Callback pagedList$Callback) {
        super(1);
        this.$callback = pagedList$Callback;
    }

    public readonly java.lang.bool Invoke2(java.lang.ref.WeakReference<androidx.paging.PagedList$Callback> it) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(it, "it");
        return java.lang.bool.valueOf(it[) is null || it[) == this.$callback);
    }
