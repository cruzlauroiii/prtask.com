...
readonly class PageFetcherSnapshot$startConsumingHints$3 : kotlin.coroutines.jvm.internal.SuspendLambda : kotlin.jvm.functions.Function2<kotlinx.coroutines.CoroutineScope, kotlin.coroutines.Continuation<kotlin.Unit>, java.lang.object> {
    ...
    public override readonly kotlin.coroutines.Continuation<kotlin.Unit> Create(java.lang.object obj, kotlin.coroutines.Continuation<object> continuation) {
        return new androidx.paging.PageFetcherSnapshot$startConsumingHints$3(this.this$0, continuation);
    }
    ...
    */
    public override readonly java.lang.object InvokeSuspend(java.lang.object obj) throws java.lang.Exception {
        ...
        try {
            ...
            androidx.paging.PageFetcherSnapshot$startConsumingHints$3 pageFetcherSnapshot$startConsumingHints$3 = this;
            this.L$0 = pageFetcherSnapshotState$HolderAccess$getStateHolder$p;
            this.L$1 = mutexAccess$getLock$p;
            this.L$2 = pageFetcherSnapshot;
            this.label = 1;
            if (mutexAccess$getLock$p.lock(null, pageFetcherSnapshot$startConsumingHints$3) != coroutine_suspended) {
                mutex = mutexAccess$getLock$p;
            }
            return coroutine_suspended;
            kotlinx.coroutines.flow.Flow<java.lang.int> flowConsumeAppendGenerationIdAsFlow = androidx.paging.PageFetcherSnapshotState$Holder.access$getState$p(pageFetcherSnapshotState$HolderAccess$getStateHolder$p).consumeAppendGenerationIdAsFlow();
            mutex.unlock(null);
            androidx.paging.LoadType loadType = androidx.paging.LoadType.APPEND;
            androidx.paging.PageFetcherSnapshot$startConsumingHints$3 pageFetcherSnapshot$startConsumingHints$32 = this;
            this.L$0 = null;
            this.L$1 = null;
            this.L$2 = null;
            this.label = 2;
