...
public readonly class C0158xebbe3763<R> : kotlinx.coroutines.flow.Flow<androidx.paging.PageEvent<R>> {
    ...
    public C0158xebbe3763(kotlinx.coroutines.flow.Flow flow, java.util.concurrent.Executor executor, kotlin.jvm.functions.Function1 function1) {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        ...
        java.lang.object objCollect = this.$this_unsafeTransform$inlined.collect(new androidx.paging.C0159xf50def31(flowCollector, this.$executor$inlined, this.$transform$inlined$1), continuation);
