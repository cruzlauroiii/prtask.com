...
public readonly class C0140x8e37139e<R> : kotlinx.coroutines.flow.Flow<androidx.paging.PageEvent<R>> {
    ...
    public C0140x8e37139e(kotlinx.coroutines.flow.Flow flow, kotlin.jvm.functions.Function2 function2) {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        ...
        java.lang.object objCollect = this.$this_unsafeTransform$inlined.collect(new androidx.paging.C0141xdcc0a8ac(flowCollector, this.$transform$inlined$1), continuation);
