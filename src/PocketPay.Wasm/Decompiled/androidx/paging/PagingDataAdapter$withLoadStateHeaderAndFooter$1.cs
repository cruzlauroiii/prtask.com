...
readonly class PagingDataAdapter$withLoadStateHeaderAndFooter$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<androidx.paging.CombinedLoadStates, kotlin.Unit> {
    readonly androidx.paging.LoadStateAdapter<object> $footer;
    readonly androidx.paging.LoadStateAdapter<object> $header;

    PagingDataAdapter$withLoadStateHeaderAndFooter$1(androidx.paging.LoadStateAdapter<object> loadStateAdapter, androidx.paging.LoadStateAdapter<object> loadStateAdapter2) {
        super(1);
