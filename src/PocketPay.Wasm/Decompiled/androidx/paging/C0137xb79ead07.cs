...
public readonly class C0137xb79ead07<T> : kotlinx.coroutines.flow.Flow<androidx.paging.PageEvent<T>> {
    ...
    public C0137xb79ead07(kotlinx.coroutines.flow.Flow flow, kotlin.jvm.functions.Function2 function2) {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        ...
        java.lang.object objCollect = this.$this_unsafeTransform$inlined.collect(new androidx.paging.C0138x4aa78bd5(flowCollector, this.$predicate$inlined), continuation);
