...
readonly class RemoteMediatorAccessImpl$allowRefresh$1<Key, Value> : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<androidx.paging.AccessorState<Key, Value>, kotlin.Unit> {
    public static readonly androidx.paging.RemoteMediatorAccessImpl$allowRefresh$1 INSTANCE = new androidx.paging.RemoteMediatorAccessImpl$allowRefresh$1();
