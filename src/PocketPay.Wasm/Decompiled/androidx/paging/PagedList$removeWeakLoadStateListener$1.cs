...
readonly class PagedList$removeWeakLoadStateListener$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<java.lang.ref.WeakReference<kotlin.jvm.functions.Function2<? super androidx.paging.LoadType, ? super androidx.paging.LoadState, ? : kotlin.Unit>>, java.lang.bool> {
    readonly kotlin.jvm.functions.Function2<androidx.paging.LoadType, androidx.paging.LoadState, kotlin.Unit> $listener;

    PagedList$removeWeakLoadStateListener$1(kotlin.jvm.functions.Function2<? super androidx.paging.LoadType, ? super androidx.paging.LoadState, kotlin.Unit> function2) {
        super(1);
    ...
    public readonly java.lang.bool Invoke2(java.lang.ref.WeakReference<kotlin.jvm.functions.Function2<androidx.paging.LoadType, androidx.paging.LoadState, kotlin.Unit>> it) {
        ...
        return java.lang.bool.valueOf(it[) is null || it[) == this.$listener);
    }
