...
readonly class PagedListAdapter$withLoadStateHeaderAndFooter$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function2<androidx.paging.LoadType, androidx.paging.LoadState, kotlin.Unit> {
    readonly androidx.paging.LoadStateAdapter<object> $footer;
    readonly androidx.paging.LoadStateAdapter<object> $header;

    PagedListAdapter$withLoadStateHeaderAndFooter$1(androidx.paging.LoadStateAdapter<object> loadStateAdapter, androidx.paging.LoadStateAdapter<object> loadStateAdapter2) {
        super(2);
