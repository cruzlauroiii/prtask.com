...
public readonly class C0143xc9f70385<R> : kotlinx.coroutines.flow.Flow<androidx.paging.PageEvent<R>> {
    ...
    public C0143xc9f70385(kotlinx.coroutines.flow.Flow flow, kotlin.jvm.functions.Function2 function2) {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        ...
        java.lang.object objCollect = this.$this_unsafeTransform$inlined.collect(new androidx.paging.C0144x28443ad3(flowCollector, this.$transform$inlined$1), continuation);
