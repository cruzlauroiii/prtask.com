...
readonly class PagedList$dispatchStateChangeAsync$1$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<java.lang.ref.WeakReference<kotlin.jvm.functions.Function2<? super androidx.paging.LoadType, ? super androidx.paging.LoadState, ? : kotlin.Unit>>, java.lang.bool> {
    public static readonly androidx.paging.PagedList$dispatchStateChangeAsync$1$1 INSTANCE = new androidx.paging.PagedList$dispatchStateChangeAsync$1$1();

    PagedList$dispatchStateChangeAsync$1$1() {
        super(1);
    }
