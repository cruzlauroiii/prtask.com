...
readonly class SimpleProducerScopeImpl$awaitClose$2$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<java.lang.Exception, kotlin.Unit> {
    readonly kotlinx.coroutines.CancellableContinuation<kotlin.Unit> $cont;

    SimpleProducerScopeImpl$awaitClose$2$1(kotlinx.coroutines.CancellableContinuation<kotlin.Unit> cancellableContinuation) {
        super(1);
