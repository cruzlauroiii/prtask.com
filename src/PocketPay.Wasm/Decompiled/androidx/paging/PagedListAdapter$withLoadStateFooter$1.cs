...
readonly class PagedListAdapter$withLoadStateFooter$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function2<androidx.paging.LoadType, androidx.paging.LoadState, kotlin.Unit> {
    readonly androidx.paging.LoadStateAdapter<object> $footer;

    PagedListAdapter$withLoadStateFooter$1(androidx.paging.LoadStateAdapter<object> loadStateAdapter) {
        super(2);
