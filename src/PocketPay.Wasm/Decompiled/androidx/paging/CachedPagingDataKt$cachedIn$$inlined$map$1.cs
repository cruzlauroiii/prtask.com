...
public readonly class CachedPagingDataKt$cachedIn$$inlined$map$1<T> : kotlinx.coroutines.flow.Flow<androidx.paging.PagingData<T>> {
    readonly kotlinx.coroutines.flow.Flow $this_unsafeTransform$inlined;

    public CachedPagingDataKt$cachedIn$$inlined$map$1(kotlinx.coroutines.flow.Flow flow) {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        java.lang.object objCollect = this.$this_unsafeTransform$inlined.collect(new androidx.paging.CachedPagingDataKt$cachedIn$$inlined$map$1$2(flowCollector), continuation);
