...
public readonly class GetAdSelectionDataRequest$Ext12Impl$Companion {
    private GetAdSelectionDataRequest$Ext12Impl$Companion() {
    }

    public GetAdSelectionDataRequest$Ext12Impl$Companion(kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }
