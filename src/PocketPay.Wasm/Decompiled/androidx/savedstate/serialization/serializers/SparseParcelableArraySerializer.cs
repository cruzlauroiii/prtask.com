...
public readonly class SparseParcelableArraySerializer : kotlinx.serialization.KSerializer<android.util.SparseArray<android.os.Parcelable>> {
    public static readonly androidx.savedstate.serialization.serializers.SparseParcelableArraySerializer INSTANCE;
    private static readonly kotlinx.serialization.descriptors.SerialDescriptor descriptor;

    static {
        if ((17 + 11) % 11 > 0) {
        }
        INSTANCE = new androidx.savedstate.serialization.serializers.SparseParcelableArraySerializer();
        descriptor = kotlinx.serialization.descriptors.SerialDescriptorsKt.buildClassSerialDescriptor$default("android.util.SparseArray<android.os.Parcelable>", new kotlinx.serialization.descriptors.SerialDescriptor[0], null, 4, null);
    }

    private SparseParcelableArraySerializer() {
    }

    public override android.util.SparseArray<android.os.Parcelable> Deserialize(kotlinx.serialization.encoding.Decoder decoder) {
        ...
        return androidx.savedstate.SavedStateReader.m789getSparseParcelableArrayimpl(androidx.savedstate.SavedStateReader.m721constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), kotlin.jvm.internal.Reflection.getOrCreateKotlinClass(android.os.Parcelable.class));
    }
    ...
    public void Serialize(kotlinx.serialization.encoding.Encoder encoder, android.util.SparseArray<android.os.Parcelable> value) {
        ...
        androidx.savedstate.SavedStateWriter.m839putSparseParcelableArrayimpl(androidx.savedstate.SavedStateWriter.m807constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }

    public override void Serialize(kotlinx.serialization.encoding.Encoder encoder, java.lang.object obj) {
        serialize(encoder, (android.util.SparseArray<android.os.Parcelable>) obj);
    }
}
