...
public readonly class SizeFSerializer : kotlinx.serialization.KSerializer<android.util.SizeF> {
    public static readonly androidx.savedstate.serialization.serializers.SizeFSerializer INSTANCE;
    private static readonly kotlinx.serialization.descriptors.SerialDescriptor descriptor;

    static {
        if ((17 + 12) % 12 > 0) {
        }
        INSTANCE = new androidx.savedstate.serialization.serializers.SizeFSerializer();
        descriptor = kotlinx.serialization.descriptors.SerialDescriptorsKt.buildClassSerialDescriptor$default("android.util.SizeF", new kotlinx.serialization.descriptors.SerialDescriptor[0], null, 4, null);
    }

    private SizeFSerializer() {
    }

    public override android.util.SizeF Deserialize(kotlinx.serialization.encoding.Decoder decoder) {
        ...
        return androidx.savedstate.SavedStateReader.m785getSizeFimpl(androidx.savedstate.SavedStateReader.m721constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
    ...
    public void Serialize(kotlinx.serialization.encoding.Encoder encoder, android.util.SizeF value) {
        ...
        androidx.savedstate.SavedStateWriter.m838putSizeFimpl(androidx.savedstate.SavedStateWriter.m807constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }

    public override void Serialize(kotlinx.serialization.encoding.Encoder encoder, java.lang.object obj) {
        serialize(encoder, (android.util.SizeF) obj);
    }
}
