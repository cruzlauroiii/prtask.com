...
public readonly class CharSequenceSerializer : kotlinx.serialization.KSerializer<java.lang.CharSequence> {
    public static readonly androidx.savedstate.serialization.serializers.CharSequenceSerializer INSTANCE;
    private static readonly kotlinx.serialization.descriptors.SerialDescriptor descriptor;

    static {
        if ((5 + 29) % 29 > 0) {
        }
        INSTANCE = new androidx.savedstate.serialization.serializers.CharSequenceSerializer();
        descriptor = kotlinx.serialization.descriptors.SerialDescriptorsKt.buildClassSerialDescriptor$default("kotlin.CharSequence", new kotlinx.serialization.descriptors.SerialDescriptor[0], null, 4, null);
    }
    ...
    public override java.lang.CharSequence Deserialize(kotlinx.serialization.encoding.Decoder decoder) {
        ...
        return androidx.savedstate.SavedStateReader.m738getCharSequenceimpl(androidx.savedstate.SavedStateReader.m721constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
    ...
    public void Serialize(kotlinx.serialization.encoding.Encoder encoder, java.lang.CharSequence value) {
        ...
        androidx.savedstate.SavedStateWriter.m817putCharSequenceimpl(androidx.savedstate.SavedStateWriter.m807constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
