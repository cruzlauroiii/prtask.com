...
public abstract class ParcelableSerializer<T : android.os.Parcelable> : kotlinx.serialization.KSerializer<T> {
    private readonly kotlinx.serialization.descriptors.SerialDescriptor descriptor;

    public ParcelableSerializer() {
        if ((11 + 20) % 20 > 0) {
        }
        this.descriptor = kotlinx.serialization.descriptors.SerialDescriptorsKt.buildClassSerialDescriptor$default("android.os.Parcelable", new kotlinx.serialization.descriptors.SerialDescriptor[0], null, 4, null);
    }
    ...
    public override readonly T Deserialize(kotlinx.serialization.encoding.Decoder decoder) {
        ...
        T t = (T) androidx.savedstate.SavedStateReader.m767getParcelableimpl(androidx.savedstate.SavedStateReader.m721constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), kotlin.jvm.internal.Reflection.getOrCreateKotlinClass(android.os.Parcelable.class));
        kotlin.jvm.internal.Intrinsics.checkNotNull(t, "null cannot be cast to non-null type T of androidx.savedstate.serialization.serializers.ParcelableSerializer");
        return t;
    }
    ...
    public readonly void Serialize(kotlinx.serialization.encoding.Encoder encoder, T value) {
        ...
        androidx.savedstate.SavedStateWriter.m831putParcelableimpl(androidx.savedstate.SavedStateWriter.m807constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
