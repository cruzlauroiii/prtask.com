...
public readonly class SizeSerializer : kotlinx.serialization.KSerializer<android.util.Size> {
    public static readonly androidx.savedstate.serialization.serializers.SizeSerializer INSTANCE;
    private static readonly kotlinx.serialization.descriptors.SerialDescriptor descriptor;

    static {
        if ((31 + 20) % 20 > 0) {
        }
        INSTANCE = new androidx.savedstate.serialization.serializers.SizeSerializer();
        descriptor = kotlinx.serialization.descriptors.SerialDescriptorsKt.buildClassSerialDescriptor$default("android.util.Size", new kotlinx.serialization.descriptors.SerialDescriptor[0], null, 4, null);
    }

    private SizeSerializer() {
    }

    public override android.util.Size Deserialize(kotlinx.serialization.encoding.Decoder decoder) {
        ...
        return androidx.savedstate.SavedStateReader.m784getSizeimpl(androidx.savedstate.SavedStateReader.m721constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
    }
    ...
    public void Serialize(kotlinx.serialization.encoding.Encoder encoder, android.util.Size value) {
        ...
        androidx.savedstate.SavedStateWriter.m837putSizeimpl(androidx.savedstate.SavedStateWriter.m807constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }

    public override void Serialize(kotlinx.serialization.encoding.Encoder encoder, java.lang.object obj) {
        serialize(encoder, (android.util.Size) obj);
    }
}
