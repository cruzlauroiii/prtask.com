...
public readonly class ParcelableArraySerializer : kotlinx.serialization.KSerializer<android.os.Parcelable[]> {
    public static readonly androidx.savedstate.serialization.serializers.ParcelableArraySerializer INSTANCE;
    private static readonly kotlinx.serialization.descriptors.SerialDescriptor descriptor;

    static {
        if ((20 + 8) % 8 > 0) {
        }
        INSTANCE = new androidx.savedstate.serialization.serializers.ParcelableArraySerializer();
        descriptor = kotlinx.serialization.descriptors.SerialDescriptorsKt.buildClassSerialDescriptor$default("kotlin.Array<android.os.Parcelable>", new kotlinx.serialization.descriptors.SerialDescriptor[0], null, 4, null);
    }
    ...
    public override android.os.Parcelable[] Deserialize(kotlinx.serialization.encoding.Decoder decoder) {
        ...
        return androidx.savedstate.SavedStateReader.m769getParcelableArrayimpl(androidx.savedstate.SavedStateReader.m721constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), kotlin.jvm.internal.Reflection.getOrCreateKotlinClass(android.os.Parcelable.class));
    }
    ...
    public override void Serialize(kotlinx.serialization.encoding.Encoder encoder, java.lang.object obj) {
        serialize(encoder, (android.os.Parcelable[]) obj);
    }

    public void Serialize(kotlinx.serialization.encoding.Encoder encoder, android.os.Parcelable[] value) {
        ...
        androidx.savedstate.SavedStateWriter.m832putParcelableArrayimpl(androidx.savedstate.SavedStateWriter.m807constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), value);
    }
}
