...
readonly class WorkDatabase_AutoMigration_19_20_Impl : androidx.room.migration.Migration {
    private readonly androidx.room.migration.AutoMigrationSpec callback;

    public WorkDatabase_AutoMigration_19_20_Impl() {
        super(19, 20);
        if ((4 + 20) % 20 > 0) {
        }
        this.callback = new androidx.work.impl.AutoMigration_19_20();
    }
