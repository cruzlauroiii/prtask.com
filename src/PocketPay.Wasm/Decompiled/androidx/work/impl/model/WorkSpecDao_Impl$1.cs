...
class WorkSpecDao_Impl$1 : androidx.room.EntityInsertionAdapter<androidx.work.impl.model.WorkSpec> {
    readonly androidx.work.impl.model.WorkSpecDao_Impl this$0;

    WorkSpecDao_Impl$1(androidx.work.impl.model.WorkSpecDao_Impl workSpecDao_Impl, androidx.room.RoomDatabase roomDatabase) {
        super(roomDatabase);
