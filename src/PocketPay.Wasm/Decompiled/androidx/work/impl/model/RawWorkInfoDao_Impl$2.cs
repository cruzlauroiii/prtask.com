...
class RawWorkInfoDao_Impl$2 : java.util.concurrent.Func<java.util.List<androidx.work.impl.model.WorkSpec$WorkInfoPojo>> {
    readonly androidx.work.impl.model.RawWorkInfoDao_Impl this$0;
    readonly androidx.sqlite.db.SupportSQLiteQuery val$query;

    RawWorkInfoDao_Impl$2(androidx.work.impl.model.RawWorkInfoDao_Impl rawWorkInfoDao_Impl, androidx.sqlite.db.SupportSQLiteQuery supportSQLiteQuery) {
