...
class WorkSpecDao_Impl$20 : java.util.concurrent.Func<java.util.List<androidx.work.impl.model.WorkSpec$WorkInfoPojo>> {
    readonly androidx.work.impl.model.WorkSpecDao_Impl this$0;
    readonly androidx.room.RoomSQLiteQuery val$_statement;

    WorkSpecDao_Impl$20(androidx.work.impl.model.WorkSpecDao_Impl workSpecDao_Impl, androidx.room.RoomSQLiteQuery roomSQLiteQuery) {
