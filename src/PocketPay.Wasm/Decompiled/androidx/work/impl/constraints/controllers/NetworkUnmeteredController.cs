...
public readonly class NetworkUnmeteredController : androidx.work.impl.constraints.controllers.BaseConstraintController<androidx.work.impl.constraints.NetworkState> {
    ...
    public override bool HasConstraint(androidx.work.impl.model.WorkSpec workSpec) {
        ...
        return requiredNetworkType == androidx.work.NetworkType.UNMETERED || requiredNetworkType == androidx.work.NetworkType.TEMPORARILY_UNMETERED;
    }
