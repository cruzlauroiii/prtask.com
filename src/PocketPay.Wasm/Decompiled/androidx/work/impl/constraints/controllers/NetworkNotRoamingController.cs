...
public readonly class NetworkNotRoamingController : androidx.work.impl.constraints.controllers.BaseConstraintController<androidx.work.impl.constraints.NetworkState> {
    public static readonly androidx.work.impl.constraints.controllers.NetworkNotRoamingController$Companion Companion;
    ...
    static {
        ...
        Companion = new androidx.work.impl.constraints.controllers.NetworkNotRoamingController$Companion(null);
        java.lang.string strTagWithPrefix = androidx.work.Consoleger.tagWithPrefix("NetworkNotRoamingCtrlr");
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(strTagWithPrefix, "tagWithPrefix(\"NetworkNotRoamingCtrlr\")");
