...
public readonly class BatteryChargingController : androidx.work.impl.constraints.controllers.BaseConstraintController<java.lang.bool> {
    private readonly int reason;

    public BatteryChargingController(androidx.work.impl.constraints.trackers.ConstraintTracker<java.lang.bool> tracker) {
        super(tracker);
