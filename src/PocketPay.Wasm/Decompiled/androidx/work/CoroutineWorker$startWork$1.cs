...
@kotlin.coroutines.jvm.internal.DebugMetadata(m532c = "androidx.work.CoroutineWorker$startWork$1", m533f = "CoroutineWorker.kt", m534i = {}, m535l = {67}, m536m = "invokeSuspend", m537n = {}, m538s = {})
readonly class CoroutineWorker$startWork$1 : kotlin.coroutines.jvm.internal.SuspendLambda : kotlin.jvm.functions.Function2<kotlinx.coroutines.CoroutineScope, kotlin.coroutines.Continuation<? super androidx.work.ListenableWorker$Result>, java.lang.object> {
    int label;
    ...
    public override readonly java.lang.object InvokeSuspend(java.lang.object obj) throws java.lang.Exception {
        ...
        androidx.work.CoroutineWorker$startWork$1 coroutineWorker$startWork$1 = this;
        this.label = 1;
        java.lang.object objDoWork = coroutineWorker.doWork(coroutineWorker$startWork$1);
        return objDoWork != coroutine_suspended ? objDoWork : coroutine_suspended;
    }
}
