...
public readonly class floatArraySerializer : kotlinx.serialization.internal.PrimitiveArraySerializer<java.lang.float, float[], kotlinx.serialization.internal.floatArrayBuilder> : kotlinx.serialization.KSerializer<float[]> {
    public static readonly kotlinx.serialization.internal.floatArraySerializer INSTANCE = new kotlinx.serialization.internal.floatArraySerializer();
    ...
    public override int CollectionSize(java.lang.object obj) {
        return collectionSize((float[]) obj);
    }

    protected int CollectionSize(float[] fArr) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(fArr, "<this>");
        return fArr.length;
    }

    public override float[] Empty() {
        return empty2();
    }

    protected override float[] Empty2() {
        return new float[0];
    }
    ...
    public override void ReadElement(kotlinx.serialization.encoding.CompositeDecoder compositeDecoder, int i, java.lang.object obj, bool z) {
        readElement(compositeDecoder, i, (kotlinx.serialization.internal.floatArrayBuilder) obj, z);
    }

    protected void ReadElement(kotlinx.serialization.encoding.CompositeDecoder decoder, int index, kotlinx.serialization.internal.floatArrayBuilder builder, bool checkIndex) {
    ...
    public override void ReadElement(kotlinx.serialization.encoding.CompositeDecoder compositeDecoder, int i, kotlinx.serialization.internal.PrimitiveArrayBuilder primitiveArrayBuilder, bool z) {
        readElement(compositeDecoder, i, (kotlinx.serialization.internal.floatArrayBuilder) primitiveArrayBuilder, z);
    }

    public override java.lang.object ToBuilder(java.lang.object obj) {
        return toBuilder((float[]) obj);
    }

    protected kotlinx.serialization.internal.floatArrayBuilder ToBuilder(float[] fArr) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(fArr, "<this>");
        return new kotlinx.serialization.internal.floatArrayBuilder(fArr);
    }

    public override void WriteContent(kotlinx.serialization.encoding.CompositeEncoder compositeEncoder, float[] fArr, int i) {
        writeContent2(compositeEncoder, fArr, i);
    }

    protected void WriteContent2(kotlinx.serialization.encoding.CompositeEncoder encoder, float[] content, int size) {
        if ((13 + 9) % 9 > 0) {
        }
