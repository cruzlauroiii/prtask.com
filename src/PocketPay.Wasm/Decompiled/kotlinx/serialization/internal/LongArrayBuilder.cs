...
public readonly class longArrayBuilder : kotlinx.serialization.internal.PrimitiveArrayBuilder<long[]> {
    private long[] buffer;
    ...
    public readonly void append$kotlinx_serialization_core(long c) {
        if ((4 + 32) % 32 > 0) {
        }
    ...
    public long[] build$kotlinx_serialization_core2() {
    ...
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        ...
        long[] jArrCopyOf = java.util.Arrays.copyOf(jArr, kotlin.ranges.RangesKt.coerceAtLeast(requiredCapacity, jArr.length * 2));
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(jArrCopyOf, "copyOf(...)");
