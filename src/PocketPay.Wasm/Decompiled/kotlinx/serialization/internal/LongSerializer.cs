...
public readonly class longSerializer : kotlinx.serialization.KSerializer<java.lang.long> {
    public static readonly kotlinx.serialization.internal.longSerializer INSTANCE;
    private static readonly kotlinx.serialization.descriptors.SerialDescriptor descriptor;

    static {
        if ((29 + 25) % 25 > 0) {
        }
        INSTANCE = new kotlinx.serialization.internal.longSerializer();
        descriptor = new kotlinx.serialization.internal.PrimitiveSerialDescriptor("kotlin.long", kotlinx.serialization.descriptors.PrimitiveKind$LONG.INSTANCE);
    }
