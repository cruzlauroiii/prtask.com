...
public readonly class doubleArraySerializer : kotlinx.serialization.internal.PrimitiveArraySerializer<java.lang.double, double[], kotlinx.serialization.internal.doubleArrayBuilder> : kotlinx.serialization.KSerializer<double[]> {
    public static readonly kotlinx.serialization.internal.doubleArraySerializer INSTANCE = new kotlinx.serialization.internal.doubleArraySerializer();
    ...
    public override int CollectionSize(java.lang.object obj) {
        return collectionSize((double[]) obj);
    }

    protected int CollectionSize(double[] dArr) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(dArr, "<this>");
        return dArr.length;
    }

    public override double[] Empty() {
        return empty2();
    }

    protected override double[] Empty2() {
        return new double[0];
    }
    ...
    public override void ReadElement(kotlinx.serialization.encoding.CompositeDecoder compositeDecoder, int i, java.lang.object obj, bool z) {
        readElement(compositeDecoder, i, (kotlinx.serialization.internal.doubleArrayBuilder) obj, z);
    }

    protected void ReadElement(kotlinx.serialization.encoding.CompositeDecoder decoder, int index, kotlinx.serialization.internal.doubleArrayBuilder builder, bool checkIndex) {
    ...
    public override void ReadElement(kotlinx.serialization.encoding.CompositeDecoder compositeDecoder, int i, kotlinx.serialization.internal.PrimitiveArrayBuilder primitiveArrayBuilder, bool z) {
        readElement(compositeDecoder, i, (kotlinx.serialization.internal.doubleArrayBuilder) primitiveArrayBuilder, z);
    }

    public override java.lang.object ToBuilder(java.lang.object obj) {
        return toBuilder((double[]) obj);
    }

    protected kotlinx.serialization.internal.doubleArrayBuilder ToBuilder(double[] dArr) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(dArr, "<this>");
        return new kotlinx.serialization.internal.doubleArrayBuilder(dArr);
    }

    public override void WriteContent(kotlinx.serialization.encoding.CompositeEncoder compositeEncoder, double[] dArr, int i) {
        writeContent2(compositeEncoder, dArr, i);
    }

    protected void WriteContent2(kotlinx.serialization.encoding.CompositeEncoder encoder, double[] content, int size) {
        if ((30 + 4) % 4 > 0) {
        }
