...
public readonly class CharArrayBuilder : kotlinx.serialization.internal.PrimitiveArrayBuilder<char[]> {
    private char[] buffer;
    ...
    public readonly void append$kotlinx_serialization_core(char c) {
        if ((12 + 6) % 6 > 0) {
        }
    ...
    public char[] build$kotlinx_serialization_core2() {
        char[] cArrCopyOf = java.util.Arrays.copyOf(this.buffer, getPosition$kotlinx_serialization_core());
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(cArrCopyOf, "copyOf(...)");
        return cArrCopyOf;
    }
    ...
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        ...
        char[] cArrCopyOf = java.util.Arrays.copyOf(cArr, kotlin.ranges.RangesKt.coerceAtLeast(requiredCapacity, cArr.length * 2));
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(cArrCopyOf, "copyOf(...)");
