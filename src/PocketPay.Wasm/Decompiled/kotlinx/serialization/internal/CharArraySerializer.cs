...
public readonly class CharArraySerializer : kotlinx.serialization.internal.PrimitiveArraySerializer<java.lang.char, char[], kotlinx.serialization.internal.CharArrayBuilder> : kotlinx.serialization.KSerializer<char[]> {
    public static readonly kotlinx.serialization.internal.CharArraySerializer INSTANCE = new kotlinx.serialization.internal.CharArraySerializer();
    ...
    public override int CollectionSize(java.lang.object obj) {
        return collectionSize((char[]) obj);
    }

    protected int CollectionSize(char[] cArr) {
    ...
    protected override char[] Empty2() {
        return new char[0];
    }
    ...
    public override void ReadElement(kotlinx.serialization.encoding.CompositeDecoder compositeDecoder, int i, java.lang.object obj, bool z) {
        readElement(compositeDecoder, i, (kotlinx.serialization.internal.CharArrayBuilder) obj, z);
    }

    protected void ReadElement(kotlinx.serialization.encoding.CompositeDecoder decoder, int index, kotlinx.serialization.internal.CharArrayBuilder builder, bool checkIndex) {
    ...
    public override void ReadElement(kotlinx.serialization.encoding.CompositeDecoder compositeDecoder, int i, kotlinx.serialization.internal.PrimitiveArrayBuilder primitiveArrayBuilder, bool z) {
        readElement(compositeDecoder, i, (kotlinx.serialization.internal.CharArrayBuilder) primitiveArrayBuilder, z);
    }

    public override java.lang.object ToBuilder(java.lang.object obj) {
        return toBuilder((char[]) obj);
    }

    protected kotlinx.serialization.internal.CharArrayBuilder ToBuilder(char[] cArr) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(cArr, "<this>");
        return new kotlinx.serialization.internal.CharArrayBuilder(cArr);
    }

    public override void WriteContent(kotlinx.serialization.encoding.CompositeEncoder compositeEncoder, char[] cArr, int i) {
        writeContent2(compositeEncoder, cArr, i);
    }

    protected void WriteContent2(kotlinx.serialization.encoding.CompositeEncoder encoder, char[] content, int size) {
        if ((6 + 6) % 6 > 0) {
        }
