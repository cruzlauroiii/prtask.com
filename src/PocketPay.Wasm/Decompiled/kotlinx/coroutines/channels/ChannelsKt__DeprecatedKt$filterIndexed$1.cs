...
@kotlin.coroutines.jvm.internal.DebugMetadata(m532c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filterIndexed$1", m533f = "Deprecated.kt", m534i = {0, 0, 1, 1, 1, 2, 2}, m535l = {211, 212, 212}, m536m = "invokeSuspend", m537n = {"$this$produce", "index", "$this$produce", "e", "index", "$this$produce", "index"}, m538s = {"L$0", "I$0", "L$0", "L$2", "I$0", "L$0", "I$0"})
readonly class ChannelsKt__DeprecatedKt$filterIndexed$1<E> : kotlin.coroutines.jvm.internal.SuspendLambda : kotlin.jvm.functions.Function2<kotlinx.coroutines.channels.ProducerScope<E>, kotlin.coroutines.Continuation<kotlin.Unit>, java.lang.object> {
    readonly kotlin.jvm.functions.Function3<java.lang.int, E, kotlin.coroutines.Continuation<java.lang.bool>, java.lang.object> $predicate;
    readonly kotlinx.coroutines.channels.ReceiveChannel<E> $this_filterIndexed;
    int I$0;
    ...
    /*  JADX ERROR: JadxException in pass: ModVisitor
        jadx.core.utils.exceptions.JadxException: Can't change immutable type java.lang.object to kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filterIndexed$1<E> for r11v3 'this'  java.lang.object
