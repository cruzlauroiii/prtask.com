...
@kotlin.coroutines.jvm.internal.DebugMetadata(m532c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$takeWhile$1", m533f = "Deprecated.kt", m534i = {0, 1, 1, 2}, m535l = {269, 270, 271}, m536m = "invokeSuspend", m537n = {"$this$produce", "$this$produce", "e", "$this$produce"}, m538s = {"L$0", "L$0", "L$2", "L$0"})
readonly class ChannelsKt__DeprecatedKt$takeWhile$1<E> : kotlin.coroutines.jvm.internal.SuspendLambda : kotlin.jvm.functions.Function2<kotlinx.coroutines.channels.ProducerScope<E>, kotlin.coroutines.Continuation<kotlin.Unit>, java.lang.object> {
    readonly kotlin.jvm.functions.Function2<E, kotlin.coroutines.Continuation<java.lang.bool>, java.lang.object> $predicate;
    readonly kotlinx.coroutines.channels.ReceiveChannel<E> $this_takeWhile;
    ...
    /*  JADX ERROR: JadxException in pass: ModVisitor
        jadx.core.utils.exceptions.JadxException: Can't change immutable type java.lang.object to kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$takeWhile$1<E> for r9v4 'this'  java.lang.object
