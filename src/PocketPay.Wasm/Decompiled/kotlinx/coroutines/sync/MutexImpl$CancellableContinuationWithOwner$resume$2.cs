...
readonly class MutexImpl$CancellableContinuationWithOwner$resume$2 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<java.lang.Exception, kotlin.Unit> {
    ...
    MutexImpl$CancellableContinuationWithOwner$resume$2(kotlinx.coroutines.sync.MutexImpl mutexImpl, kotlinx.coroutines.sync.MutexImpl$CancellableContinuationWithOwner mutexImpl$CancellableContinuationWithOwner) {
        super(1);
