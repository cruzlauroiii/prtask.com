...
public interface SharedFlow<T> : kotlinx.coroutines.flow.Flow<T> {
    java.lang.object collect(kotlinx.coroutines.flow.FlowCollector<T> flowCollector, kotlin.coroutines.Continuation<object> continuation);
