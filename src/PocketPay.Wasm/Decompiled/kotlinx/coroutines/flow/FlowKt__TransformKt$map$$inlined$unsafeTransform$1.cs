...
public readonly class FlowKt__TransformKt$map$$inlined$unsafeTransform$1<R> : kotlinx.coroutines.flow.Flow<R> {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        ...
        java.lang.object objCollect = this.$this_unsafeTransform$inlined.collect(new kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2(flowCollector, this.$transform$inlined$1), continuation);
    ...
    public java.lang.object collect$$forInline(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        ...
        new kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$1(this, continuation);
        this.$this_unsafeTransform$inlined.collect(new kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2(flowCollector, this.$transform$inlined$1), continuation);
