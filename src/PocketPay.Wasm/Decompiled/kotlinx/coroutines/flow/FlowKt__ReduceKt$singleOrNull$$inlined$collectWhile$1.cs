...
public readonly class FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1<T> : kotlinx.coroutines.flow.FlowCollector<T> {
    readonly kotlin.jvm.internal.Ref$objectRef $result$inlined;

    public FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1(kotlin.jvm.internal.Ref$objectRef ref$objectRef) {
    ...
    public override java.lang.object Emit(T t, kotlin.coroutines.Continuation<kotlin.Unit> continuation) {
        if (this.$result$inlined.element == kotlinx.coroutines.flow.internal.NullSurrogateKt.NULL) {
            this.$result$inlined.element = t;
            return kotlin.Unit.INSTANCE;
        }
        this.$result$inlined.element = (T) kotlinx.coroutines.flow.internal.NullSurrogateKt.NULL;
