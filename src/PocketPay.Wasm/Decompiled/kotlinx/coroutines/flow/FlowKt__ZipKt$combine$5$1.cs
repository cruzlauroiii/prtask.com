...
readonly class FlowKt__ZipKt$combine$5$1<T> : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function0<T[]> {
    readonly kotlinx.coroutines.flow.Flow<T>[] $flows;

    public FlowKt__ZipKt$combine$5$1(kotlinx.coroutines.flow.Flow<? : T>[] flowArr) {
        super(0);
        this.$flows = flowArr;
    }
