...
readonly class FlowKt__ReduceKt$lastOrNull$2<T> : kotlinx.coroutines.flow.FlowCollector {
    readonly kotlin.jvm.internal.Ref$objectRef<T> $result;

    FlowKt__ReduceKt$lastOrNull$2(kotlin.jvm.internal.Ref$objectRef<T> ref$objectRef) {
