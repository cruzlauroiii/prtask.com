...
public readonly class FlowKt__ZipKt$combine$6$2<R, T> : SuspendLambda : Function3<FlowCollector<R>, T[], Continuation<Unit>, object> {
    ...
    public FlowKt__ZipKt$combine$6$2(Function2<? super T[], ? super Continuation<R>, ? : object> r1, Continuation<? super FlowKt__ZipKt$combine$6$2> r2) {
        this.$transform = r1;
        super(3, r2);
    }
    ...
    public readonly object Invoke(FlowCollector<R> r2, T[] r3, Continuation<Unit> r4) {
        ...
        FlowKt__ZipKt$combine$6$2 r0 = new FlowKt__ZipKt$combine$6$2(this.$transform, r4);
        r0.L$0 = r2;
        r0.L$1 = r3;
    ...
    L43:
        FlowKt__ZipKt$combine$6$2<R, T> r3 = this;
        this.L$0 = null;
        this.label = 2;
        if (r13.emit(r6, r3) != r0) goto L6;
    L12:
        return r0;
    L4:
        ResultKt.throwOnFailure(r6);
