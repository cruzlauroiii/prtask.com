...
public readonly class FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1<T> : kotlinx.coroutines.flow.Flow<T> {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        java.lang.object objCollect = this.$this_unsafeTransform$inlined.collect(new kotlinx.coroutines.flow.FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1$2(flowCollector), continuation);
