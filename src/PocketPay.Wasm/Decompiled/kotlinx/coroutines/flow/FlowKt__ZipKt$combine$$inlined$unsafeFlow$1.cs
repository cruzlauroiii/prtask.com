...
public readonly class FlowKt__ZipKt$combine$$inlined$unsafeFlow$1<R> : kotlinx.coroutines.flow.Flow<R> {
    readonly kotlinx.coroutines.flow.Flow $flow$inlined;
    readonly kotlinx.coroutines.flow.Flow $this_combine$inlined;
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector<R> flowCollector, kotlin.coroutines.Continuation<kotlin.Unit> continuation) {
        ...
        java.lang.object objCombineInternal = kotlinx.coroutines.flow.internal.CombineKt.combineInternal(flowCollector, new kotlinx.coroutines.flow.Flow[]{this.$this_combine$inlined, this.$flow$inlined}, kotlinx.coroutines.flow.FlowKt__ZipKt.access$nullArrayFactory(), new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$1$1(this.$transform$inlined, null), continuation);
