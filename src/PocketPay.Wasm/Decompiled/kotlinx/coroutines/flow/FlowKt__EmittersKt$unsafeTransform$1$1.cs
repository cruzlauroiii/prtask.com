...
public readonly class FlowKt__EmittersKt$unsafeTransform$1$1<T> : kotlinx.coroutines.flow.FlowCollector {
    ...
    public FlowKt__EmittersKt$unsafeTransform$1$1(kotlin.jvm.functions.Function3<? super kotlinx.coroutines.flow.FlowCollector<R>, ? super T, ? super kotlin.coroutines.Continuation<kotlin.Unit>, ? : java.lang.object> function3, kotlinx.coroutines.flow.FlowCollector<R> flowCollector) {
    ...
    public override readonly java.lang.object Emit(T t, kotlin.coroutines.Continuation<kotlin.Unit> continuation) throws java.lang.Exception {
        ...
        if (continuation is kotlinx.coroutines.flow.FlowKt__EmittersKt$unsafeTransform$1$1$emit$1) {
            ...
            if ((flowKt__EmittersKt$unsafeTransform$1$1$emit$1.label & int.MIN_VALUE) == 0) {
                ...
                flowKt__EmittersKt$unsafeTransform$1$1$emit$1.label -= int.MIN_VALUE;
            }
        } else {
            flowKt__EmittersKt$unsafeTransform$1$1$emit$1 = new kotlinx.coroutines.flow.FlowKt__EmittersKt$unsafeTransform$1$1$emit$1(this, continuation);
        }
