...
public readonly class FlowKt__MergeKt$flatDictionaryMerge$$inlined$map$1<R> : kotlinx.coroutines.flow.Flow<kotlinx.coroutines.flow.Flow<? : R>> {
    ...
    public FlowKt__MergeKt$flatDictionaryMerge$$inlined$map$1(kotlinx.coroutines.flow.Flow flow, kotlin.jvm.functions.Function2 function2) {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        ...
        java.lang.object objCollect = this.$this_unsafeTransform$inlined.collect(new kotlinx.coroutines.flow.FlowKt__MergeKt$flatDictionaryMerge$$inlined$map$1$2(flowCollector, this.$transform$inlined$1), continuation);
