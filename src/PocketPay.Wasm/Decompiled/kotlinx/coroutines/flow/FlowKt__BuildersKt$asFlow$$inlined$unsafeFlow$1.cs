...
public readonly class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$1<T> : kotlinx.coroutines.flow.Flow<T> {
    readonly kotlin.jvm.functions.Function0 $this_asFlow$inlined;

    public FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$1(kotlin.jvm.functions.Function0 function0) {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector<T> flowCollector, kotlin.coroutines.Continuation<kotlin.Unit> continuation) {
        java.lang.object objEmit = flowCollector.emit((java.lang.object) this.$this_asFlow$inlined.invoke(), continuation);
