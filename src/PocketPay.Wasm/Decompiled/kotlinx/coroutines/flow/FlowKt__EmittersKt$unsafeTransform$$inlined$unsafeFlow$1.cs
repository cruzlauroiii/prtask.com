...
public readonly class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1<R> : kotlinx.coroutines.flow.Flow<R> {
    ...
    public java.lang.object collect$$forInline(kotlinx.coroutines.flow.FlowCollector flowCollector, kotlin.coroutines.Continuation continuation) {
        ...
        new kotlinx.coroutines.flow.FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1$1(this, continuation);
        this.$this_unsafeTransform$inlined.collect(new kotlinx.coroutines.flow.FlowKt__EmittersKt$unsafeTransform$1$1(this.$transform$inlined, flowCollector), continuation);
