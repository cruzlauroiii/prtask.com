...
@kotlin.coroutines.jvm.internal.DebugMetadata(m532c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", m533f = "Zip.kt", m534i = {}, m535l = {308}, m536m = "invokeSuspend", m537n = {}, m538s = {})
public readonly class FlowKt__ZipKt$combineTransform$7$2<R, T> : kotlin.coroutines.jvm.internal.SuspendLambda : kotlin.jvm.functions.Function3<kotlinx.coroutines.flow.FlowCollector<R>, T[], kotlin.coroutines.Continuation<kotlin.Unit>, java.lang.object> {
    ...
    public FlowKt__ZipKt$combineTransform$7$2(kotlin.jvm.functions.Function3<? super kotlinx.coroutines.flow.FlowCollector<R>, ? super T[], ? super kotlin.coroutines.Continuation<kotlin.Unit>, ? : java.lang.object> function3, kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2> continuation) {
    ...
    public readonly java.lang.object Invoke(kotlinx.coroutines.flow.FlowCollector<R> flowCollector, T[] tArr, kotlin.coroutines.Continuation<kotlin.Unit> continuation) {
        ...
        kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 flowKt__ZipKt$combineTransform$7$2 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2(this.$transform, continuation);
        flowKt__ZipKt$combineTransform$7$2.L$0 = flowCollector;
        flowKt__ZipKt$combineTransform$7$2.L$1 = tArr;
        return flowKt__ZipKt$combineTransform$7$2.invokeSuspend(kotlin.Unit.INSTANCE);
    }
