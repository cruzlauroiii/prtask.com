...
readonly class DistinctFlowImpl<T> : kotlinx.coroutines.flow.Flow<T> {
    public readonly kotlin.jvm.functions.Function2<java.lang.object, java.lang.object, java.lang.bool> areEquivalent;
    public readonly kotlin.jvm.functions.Function1<T, java.lang.object> keySelector;
    private readonly kotlinx.coroutines.flow.Flow<T> upstream;

    public DistinctFlowImpl(kotlinx.coroutines.flow.Flow<? : T> flow, kotlin.jvm.functions.Function1<? super T, ? : java.lang.object> function1, kotlin.jvm.functions.Function2<java.lang.object, java.lang.object, java.lang.bool> function2) {
        this.upstream = flow;
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector<T> flowCollector, kotlin.coroutines.Continuation<kotlin.Unit> continuation) {
        ...
        java.lang.object objCollect = this.upstream.collect(new kotlinx.coroutines.flow.DistinctFlowImpl$collect$2(this, ref$objectRef, flowCollector), continuation);
