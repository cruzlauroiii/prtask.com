...
@kotlin.coroutines.jvm.internal.DebugMetadata(m532c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m533f = "Delay.kt", m534i = {}, m535l = {279}, m536m = "invokeSuspend", m537n = {}, m538s = {})
readonly class FlowKt__DelayKt$sample$2$values$1 : kotlin.coroutines.jvm.internal.SuspendLambda : kotlin.jvm.functions.Function2<kotlinx.coroutines.channels.ProducerScope<java.lang.object>, kotlin.coroutines.Continuation<kotlin.Unit>, java.lang.object> {
    readonly kotlinx.coroutines.flow.Flow<T> $this_sample;
    private java.lang.object L$0;
    int label;

    FlowKt__DelayKt$sample$2$values$1(kotlinx.coroutines.flow.Flow<? : T> flow, kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1> continuation) {
    ...
    public override readonly java.lang.object InvokeSuspend(java.lang.object obj) throws java.lang.Exception {
        ...
        if (i == 0) {
            ...
            kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1$1 flowKt__DelayKt$sample$2$values$1$1 = new kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1$1(producerScope);
            kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1 flowKt__DelayKt$sample$2$values$1 = this;
            this.label = 1;
            if (flow.collect(flowKt__DelayKt$sample$2$values$1$1, flowKt__DelayKt$sample$2$values$1) == coroutine_suspended) {
