...
public readonly class FlowKt__ReduceKt$first$$inlined$collectWhile$1<T> : kotlinx.coroutines.flow.FlowCollector<T> {
    readonly kotlin.jvm.internal.Ref$objectRef $result$inlined;

    public FlowKt__ReduceKt$first$$inlined$collectWhile$1(kotlin.jvm.internal.Ref$objectRef ref$objectRef) {
