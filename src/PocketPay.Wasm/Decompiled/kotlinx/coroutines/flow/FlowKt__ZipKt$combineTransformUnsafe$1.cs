...
@kotlin.coroutines.jvm.internal.DebugMetadata(m532c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1", m533f = "Zip.kt", m534i = {}, m535l = {273}, m536m = "invokeSuspend", m537n = {}, m538s = {})
public readonly class FlowKt__ZipKt$combineTransformUnsafe$1<R> : kotlin.coroutines.jvm.internal.SuspendLambda : kotlin.jvm.functions.Function2<kotlinx.coroutines.flow.FlowCollector<R>, kotlin.coroutines.Continuation<kotlin.Unit>, java.lang.object> {
    ...
    public FlowKt__ZipKt$combineTransformUnsafe$1(kotlinx.coroutines.flow.Flow<? : T>[] flowArr, kotlin.jvm.functions.Function3<? super kotlinx.coroutines.flow.FlowCollector<R>, ? super T[], ? super kotlin.coroutines.Continuation<kotlin.Unit>, ? : java.lang.object> function3, kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1> continuation) {
    ...
    public override readonly java.lang.object InvokeSuspend(java.lang.object obj) throws java.lang.Exception {
        ...
        if (i == 0) {
            ...
            kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1$1 flowKt__ZipKt$combineTransformUnsafe$1$1 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1$1(this.$transform, null);
            kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1<R> flowKt__ZipKt$combineTransformUnsafe$1 = this;
            this.label = 1;
            if (kotlinx.coroutines.flow.internal.CombineKt.combineInternal(flowCollector, flowArr, function0Access$nullArrayFactory, flowKt__ZipKt$combineTransformUnsafe$1$1, flowKt__ZipKt$combineTransformUnsafe$1) == coroutine_suspended) {
    ...
    public readonly java.lang.object invokeSuspend$$forInline(java.lang.object obj) {
        ...
        kotlin.jvm.functions.Function0 function0Access$nullArrayFactory = kotlinx.coroutines.flow.FlowKt__ZipKt.access$nullArrayFactory();
        kotlin.jvm.internal.Intrinsics.needClassReification();
        kotlinx.coroutines.flow.internal.CombineKt.combineInternal(flowCollector, flowArr, function0Access$nullArrayFactory, new kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1$1(this.$transform, null), this);
        return kotlin.Unit.INSTANCE;
    }
}
