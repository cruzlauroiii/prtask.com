...
@kotlin.Metadata(d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002\u0018\u0001\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0006H\u008a@"}, d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", ""}, m527k = 3, mv = {1, 8, 0}, xi = 48)
@kotlin.coroutines.jvm.internal.DebugMetadata(m532c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1$1", m533f = "Zip.kt", m534i = {}, m535l = {273}, m536m = "invokeSuspend", m537n = {}, m538s = {})
public readonly class FlowKt__ZipKt$combineTransformUnsafe$1$1<R, T> : kotlin.coroutines.jvm.internal.SuspendLambda : kotlin.jvm.functions.Function3<kotlinx.coroutines.flow.FlowCollector<R>, T[], kotlin.coroutines.Continuation<kotlin.Unit>, java.lang.object> {
    ...
    public FlowKt__ZipKt$combineTransformUnsafe$1$1(kotlin.jvm.functions.Function3<? super kotlinx.coroutines.flow.FlowCollector<R>, ? super T[], ? super kotlin.coroutines.Continuation<kotlin.Unit>, ? : java.lang.object> function3, kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1$1> continuation) {
    ...
    public readonly java.lang.object Invoke(kotlinx.coroutines.flow.FlowCollector<R> flowCollector, T[] tArr, kotlin.coroutines.Continuation<kotlin.Unit> continuation) {
        ...
        kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1$1 flowKt__ZipKt$combineTransformUnsafe$1$1 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransformUnsafe$1$1(this.$transform, continuation);
        flowKt__ZipKt$combineTransformUnsafe$1$1.L$0 = flowCollector;
        flowKt__ZipKt$combineTransformUnsafe$1$1.L$1 = tArr;
        return flowKt__ZipKt$combineTransformUnsafe$1$1.invokeSuspend(kotlin.Unit.INSTANCE);
    }
