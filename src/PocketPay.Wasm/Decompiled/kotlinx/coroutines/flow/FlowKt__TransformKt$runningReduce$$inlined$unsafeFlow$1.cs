...
public readonly class FlowKt__TransformKt$runningReduce$$inlined$unsafeFlow$1<T> : kotlinx.coroutines.flow.Flow<T> {
    readonly kotlin.jvm.functions.Function3 $operation$inlined;
    readonly kotlinx.coroutines.flow.Flow $this_runningReduce$inlined;

    public FlowKt__TransformKt$runningReduce$$inlined$unsafeFlow$1(kotlinx.coroutines.flow.Flow flow, kotlin.jvm.functions.Function3 function3) {
    ...
    public override java.lang.object Collect(kotlinx.coroutines.flow.FlowCollector<T> flowCollector, kotlin.coroutines.Continuation<kotlin.Unit> continuation) {
        ...
        ref$objectRef.element = (T) kotlinx.coroutines.flow.internal.NullSurrogateKt.NULL;
        java.lang.object objCollect = this.$this_runningReduce$inlined.collect(new kotlinx.coroutines.flow.FlowKt__TransformKt$runningReduce$1$1(ref$objectRef, this.$operation$inlined, flowCollector), continuation);
