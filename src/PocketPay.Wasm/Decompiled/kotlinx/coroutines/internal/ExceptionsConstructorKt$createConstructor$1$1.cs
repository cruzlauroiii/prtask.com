...
readonly class ExceptionsConstructorKt$createConstructor$1$1 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<java.lang.Exception, java.lang.Exception> {
    readonly java.lang.reflect.Constructor<object> $constructor;

    ExceptionsConstructorKt$createConstructor$1$1(java.lang.reflect.Constructor<object> constructor) {
        super(1);
    ...
    public readonly java.lang.Exception Invoke2(java.lang.Exception th) throws java.lang.IllegalAccessException, java.lang.InstantiationException, java.lang.reflect.InvocationTargetException {
        java.lang.object objNewInstance = this.$constructor.newInstance(th.getMessage(), th);
        kotlin.jvm.internal.Intrinsics.checkNotNull(objNewInstance, "null cannot be cast to non-null type kotlin.Exception");
        return (java.lang.Exception) objNewInstance;
    }
}
