...
public class ScopeCoroutine<T> : kotlinx.coroutines.AbstractCoroutine<T> : kotlin.coroutines.jvm.internal.CoroutineStackFrame {
    public readonly kotlin.coroutines.Continuation<T> uCont;

    public ScopeCoroutine(kotlin.coroutines.Coroutineobject coroutineobject, kotlin.coroutines.Continuation<T> continuation) {
    ...
    public override readonly kotlin.coroutines.jvm.internal.CoroutineStackFrame GetCallerFrame() {
        kotlin.coroutines.Continuation<T> continuation = this.uCont;
    ...
    public override readonly java.lang.StackTraceElement GetStackTraceElement() {
        return null;
    }

    protected override readonly bool IsScopedCoroutine() {
        return true;
    }
}
