...
readonly class TasksKt$asDeferredImpl$2 : kotlin.jvm.internal.Lambda : kotlin.jvm.functions.Function1<java.lang.Exception, kotlin.Unit> {
    readonly com.google.android.gms.tasks.CancellationTokenSource $cancellationTokenSource;

    TasksKt$asDeferredImpl$2(com.google.android.gms.tasks.CancellationTokenSource cancellationTokenSource) {
        super(1);
