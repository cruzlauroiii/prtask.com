...
class p20e4401d$3 : androidx.room.EntityInsertionAdapter<p4670093c.p07214c67.pd77d5e50.p0fc46d65> {
    readonly p4670093c.pf0719ea8.p20e4401d this$0;

    p20e4401d$3(p4670093c.pf0719ea8.p20e4401d p20e4401dVar, androidx.room.RoomDatabase roomDatabase) {
        super(roomDatabase);
    ...
    protected override java.lang.string CreateQuery() {
        return "INSERT OR ABORT INTO `current_payback_payment` (`uuid`,`receiptUuid`,`paymentType`,`amount`,`tapOnPhoneRefId`,`transaction_rrn`,`transaction_stan`,`transaction_authCode`,`transaction_responseCode`,`transaction_topRefUuid`,`transaction_terminalId`,`transaction_merchantId`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
    }
}
