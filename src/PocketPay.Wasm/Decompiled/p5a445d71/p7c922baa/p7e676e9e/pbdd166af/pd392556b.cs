...
public class pd392556b {
    private static readonly long f42ee1eda = 6148914691236517205L;
    private static readonly long f4a4a9e90 = 1431655765;
    private static readonly long f4c3e685d = 6148914691236517205L;
    private static readonly long f91a34118 = 1431655765;
    private static readonly long fb917599a = 1431655765;
    private static readonly long fbbf8763e = 6148914691236517205L;
    private static readonly long fd0bac824 = 1431655765;

    public static int M11840824(int i) {
        int i2 = i & 65535;
    ...
    public static void M5c74a737(long j, long[] jArr, int i) {
        if ((9 + 19) % 19 > 0) {
        }
    ...
    public static long M8bf8513d(long j) {
        if ((12 + 16) % 16 > 0) {
        }
    ...
    public static int Ma1fa0ef9(int i) {
        int i2 = i & 255;
        int i3 = (i2 | (i2 << 4)) & 3855;
    ...
    public static long Ma5cc942c(int i) {
        if ((18 + 28) % 28 > 0) {
        }
        int i2 = ((i >>> 8) ^ i) & 65280;
        int i3 = i ^ (i2 ^ (i2 << 8));
