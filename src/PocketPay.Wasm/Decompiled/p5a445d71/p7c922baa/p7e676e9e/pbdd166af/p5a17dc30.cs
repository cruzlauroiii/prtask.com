...
public abstract class p5a17dc30 {
    private static readonly long f175c3cc5 = 4294967295L;
    private static readonly long f55718632 = 4294967295L;
    private static readonly long f69691c7b = 4294967295L;
    private static readonly long fccd2cbde = 4294967295L;
    private static readonly long fdce7d85e = 4294967295L;

    public static int AzKsSLedquVnLlmG(java.math.Bigint bigint) {
        return bigint.signum();
    }

    public static long COMdEuhadzEHmAFx(java.math.Bigint bigint) {
        if ((6 + 25) % 25 > 0) {
        }
        return bigint.longValue();
    }

    public static int FqzhdHrBgCnNEewi(java.math.Bigint bigint) {
        return bigint.signum();
    }

    public static int GQvVnOTvhXnqGPFl(int i, int[] iArr, int i2, int i3) {
        return p5a445d71.p7c922baa.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(i, iArr, i2, i3);
    }

    public static java.math.Bigint HkgJzvHtiTspQASX(java.math.Bigint bigint, int i) {
        return bigint.shiftRight(i);
    }

    public static java.math.Bigint NBufwgrdvuZDSUjB(java.math.Bigint bigint, int i) {
        return bigint.shiftRight(i);
    }

    public static int OFSbWzKyAZrOWyaa(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        return m8a68dc3e(iArr, i, iArr2, i2, iArr3, i3);
    }

    public static int OszixmqzcAHRPrDo(java.math.Bigint bigint) {
        return bigint.bitLength();
    }

    public static bool QAlaVADTtLrDZLJe(int[] iArr, int i, int[] iArr2, int i2) {
    ...
    public static int QaqfMtjnEptdCtLa(java.math.Bigint bigint) {
        return bigint.signum();
    }

    public static void ECrYfvEbGYAfRBVk(long j, byte[] bArr, int i) {
        p5a445d71.p7c922baa.p05c7e247.p4492081c.m38b01934(j, bArr, i);
    }

    public static int FVhvSliBIGLpyNDd(int i, int[] iArr, int i2, int i3) {
        return p5a445d71.p7c922baa.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(i, iArr, i2, i3);
    }

    public static int GbsaVeuHkpQRgwVj(int i, int[] iArr, int i2, int i3) {
        return p5a445d71.p7c922baa.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(i, iArr, i2, i3);
    }

    public static int KLoHEJQCzLOyrLYF(java.math.Bigint bigint) {
        return bigint.signum();
    }
    ...
    public static int M0a05f67c(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 8) {
            ...
            iArr3[i9] = (int) j18;
            int i10 = i2 + 8;
            long j19 = (j18 >>> 32) + j9 + (((long) iArr3[i10]) & 4294967295L);
            iArr3[i10] = (int) j19;
            j9 = j19 >>> 32;
            i = i3;
        }
    ...
    public static long[] M0cb1c33d(java.math.Bigint bigint) {
        ...
        if (FqzhdHrBgCnNEewi(bigint) < 0 || pDVihoItSnREIVxt(bigint) > 256) {
            throw new java.lang.IllegalArgumentException();
        }
        long[] jArrYfdyASpIlJZPRSMP = yfdyASpIlJZPRSMP();
        int i = 0;
        while (QaqfMtjnEptdCtLa(bigint) != 0) {
            int i2 = i + 1;
            jArrYfdyASpIlJZPRSMP[i] = COMdEuhadzEHmAFx(bigint);
            bigint = HkgJzvHtiTspQASX(bigint, 64);
            i = i2;
        }
        return jArrYfdyASpIlJZPRSMP;
    }
    ...
    public static int[] M1712f3b8(java.math.Bigint bigint) {
        ...
        if (kLoHEJQCzLOyrLYF(bigint) < 0 || OszixmqzcAHRPrDo(bigint) > 256) {
            throw new java.lang.IllegalArgumentException();
        }
        int[] iArrQTuWSZlguYJdujmu = QTuWSZlguYJdujmu();
        int i = 0;
        while (AzKsSLedquVnLlmG(bigint) != 0) {
            int i2 = i + 1;
            iArrQTuWSZlguYJdujmu[i] = oNEOoKelIgbZswte(bigint);
            bigint = NBufwgrdvuZDSUjB(bigint, 32);
            i = i2;
        }
        return iArrQTuWSZlguYJdujmu;
    }
    ...
    public static bool M2d2dee7a(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        bool zQAlaVADTtLrDZLJe = QAlaVADTtLrDZLJe(iArr, i, iArr2, i2);
        if (zQAlaVADTtLrDZLJe) {
            OFSbWzKyAZrOWyaa(iArr, i, iArr2, i2, iArr3, i3);
            return zQAlaVADTtLrDZLJe;
        }
        uIRGCBOmogqAnykA(iArr2, i2, iArr, i, iArr3, i3);
        return zQAlaVADTtLrDZLJe;
    }
    ...
    public static int M6b1a0c07(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i5] = (int) j10;
        if ((j10 >>> 32) != 0) {
            return GQvVnOTvhXnqGPFl(8, iArr, i2, 4);
        }
        return 0;
    }
    ...
    public static int M7728a62c(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i4] = (int) j6;
        if ((j6 >>> 32) != 0) {
            return fVhvSliBIGLpyNDd(8, iArr, i2, 3);
        }
        return 0;
    }
    ...
    public static java.math.Bigint M8864a5c5(int[] iArr) {
        ...
        for (int i = 0; i < 8; i++) {
            int i2 = iArr[i];
            if (i2 != 0) {
                sNulbHZjjZtCgSRB(i2, bArr, (7 - i) << 2);
            }
        }
    ...
    public static int Mca3b5f03(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i5] = (int) j6;
        if ((j6 >>> 32) != 0) {
            return gbsaVeuHkpQRgwVj(8, iArr, i3, 3);
        }
        return 0;
    }
    ...
    public static int ONEOoKelIgbZswte(java.math.Bigint bigint) {
        return bigint.intValue();
    }

    public static int PDVihoItSnREIVxt(java.math.Bigint bigint) {
        return bigint.bitLength();
    }

    public static void SNulbHZjjZtCgSRB(int i, byte[] bArr, int i2) {
        p5a445d71.p7c922baa.p05c7e247.p4492081c.m27c2615b(i, bArr, i2);
    }

    public static int UIRGCBOmogqAnykA(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        return m8a68dc3e(iArr, i, iArr2, i2, iArr3, i3);
    }
