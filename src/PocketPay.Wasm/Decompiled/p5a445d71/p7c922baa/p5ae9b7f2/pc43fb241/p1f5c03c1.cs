...
public class p1f5c03c1 : p5a445d71.p7c922baa.p5ae9b7f2.pc43fb241.p1d0e61fd {
    private byte[] f07ca785e;
    private byte[] f5b1e4046;
    private byte f69239867;
    private byte f81140855;
    private byte f8e69459b;
    private byte fca93532f;
    ...
    public static byte[] EibdwmCcZmzdPALx(long j) {
        return p5a445d71.p7c922baa.p05c7e247.p4492081c.m38b01934(j);
    }

    public static void HZPBioAVCECKVYQY(p5a445d71.p7c922baa.p5ae9b7f2.pc43fb241.p1f5c03c1 p1f5c03c1Var, byte[] bArr, int i, int i2) {
        p1f5c03c1Var.nextbytes(bArr, i, i2);
    }

    public static void MWRSglOGJObbqGzH(p5a445d71.p7c922baa.p5ae9b7f2.pc43fb241.p1f5c03c1 p1f5c03c1Var, byte[] bArr) {
        p1f5c03c1Var.addSeedMaterial(bArr);
    }

    public override void AddSeedMaterial(long j) {
        mWRSglOGJObbqGzH(this, EibdwmCcZmzdPALx(j));
    }
    ...
    public override void Nextbytes(byte[] bArr) {
        ...
        HZPBioAVCECKVYQY(this, bArr, 0, bArr.length);
    }
