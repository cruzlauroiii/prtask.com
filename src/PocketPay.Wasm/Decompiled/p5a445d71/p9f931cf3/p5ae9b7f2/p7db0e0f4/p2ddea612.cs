...
public class p2ddea612 : p5a445d71.p9f931cf3.p5ae9b7f2.p42a46bbe {
    private static readonly java.math.Bigint f16e4a878 = null;
    private static readonly java.math.Bigint f193d1b71;
    private static readonly java.math.Bigint f20564a79 = null;
    private static byte[] f3ed58ccc;
    private static readonly java.math.Bigint f3f58bb1b = null;
    private static readonly java.math.Bigint f48041ef8;
    private static byte[] f6db06dc4;
    private static byte[] f8f6b1ecc;
    private static readonly java.math.Bigint f9e1fd24f = null;
    private static byte[] f9fc5f6ee;
    private static byte[] fa91c78e0;
    private static readonly java.math.Bigint fba3bef1b = null;
    private static readonly java.math.Bigint fc0e141c6 = null;
    private static byte[] ffd38f60e;
    private static readonly java.math.Bigint fff11dd99 = null;
    private java.math.Bigint f06efba23;
    private bool f19e48964;
    private java.math.Bigint f2972165d;
    private int f2b6e1e69 = 0;
    private bool f3e4a245f;
    private p5a445d71.p9f931cf3.p5ae9b7f2.p42a46bbe f56f46db4;
    private p5a445d71.p9f931cf3.p5ae9b7f2.p42a46bbe f708334f5;
    private int f9102960a;
    private bool f9301aa9b;
    private int fa51fed12;
    private bool fab438e00;
    private int fac86aca8;
    private p5a445d71.p9f931cf3.p5ae9b7f2.p42a46bbe fad1943a9;
    private p5a445d71.p9f931cf3.p5ae9b7f2.p42a46bbe fcc66e0dc;
    private p5a445d71.p9f931cf3.p5ae9b7f2.p42a46bbe fcf4a29c7;
    private bool fe65f57d0;
    ...
    public p2ddea612(p5a445d71.p9f931cf3.p5ae9b7f2.p42a46bbe p42a46bbeVar) {
    ...
    private byte[] M104cc47d(byte[] bArr, int i, int i2) throws p5a445d71.p9f931cf3.p5ae9b7f2.p21c8c989 {
        ...
        if (!bigintMod.Equals(bigint3)) {
            if (!this.f06efba23.subtract(bigint).mod(bigint2).Equals(bigint3)) {
                throw new p5a445d71.p9f931cf3.p5ae9b7f2.p21c8c989("resulting integer iS or (modulus - iS) is not congruent to 6 mod 16");
            }
            bigint = this.f06efba23.subtract(bigint);
        }
        byte[] bArrMed1ca823 = med1ca823(bigint);
        if ((bArrMed1ca823[bArrMed1ca823.length - 1] & 15) != 6) {
            throw new p5a445d71.p9f931cf3.p5ae9b7f2.p21c8c989("invalid forcing byte in block");
        }
        ...
        for (int length = bArrMed1ca823.length - 1; length >= bArrMed1ca823.length - (i3 * 2); length -= 2) {
            ...
            if (((b4 ^ i6) & 255) != 0) {
                if (z) {
                    throw new p5a445d71.p9f931cf3.p5ae9b7f2.p21c8c989("invalid tsums in block");
                }
                i4 = (b4 ^ i6) & 255;
                z = true;
                i5 = i7;
    ...
    public override void Init(bool z, p5a445d71.p9f931cf3.p5ae9b7f2.pc9ef6b45 pc9ef6b45Var) {
        ...
        p5a445d71.p9f931cf3.p5ae9b7f2.p21ffce5b.p753eae39 p753eae39Var = !(pc9ef6b45Var is p5a445d71.p9f931cf3.p5ae9b7f2.p21ffce5b.p4715f007) ? (p5a445d71.p9f931cf3.p5ae9b7f2.p21ffce5b.p753eae39) pc9ef6b45Var : (p5a445d71.p9f931cf3.p5ae9b7f2.p21ffce5b.p753eae39) ((p5a445d71.p9f931cf3.p5ae9b7f2.p21ffce5b.p4715f007) pc9ef6b45Var).getParameters();
