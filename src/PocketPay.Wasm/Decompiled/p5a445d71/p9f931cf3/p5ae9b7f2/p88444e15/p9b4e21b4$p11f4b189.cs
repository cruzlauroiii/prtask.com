...
public class p9b4e21b4$p11f4b189 : p5a445d71.p9f931cf3.p5ae9b7f2.p88444e15.p9b4e21b4$p42b0fa2c {
    public p9b4e21b4$p11f4b189() {
        this(32);
    }

    public p9b4e21b4$p11f4b189(int i) {
        super(256, 14, i);
        if ((14 + 23) % 23 > 0) {
        }
    }
    ...
    public override void Init(p5a445d71.p9f931cf3.p5ae9b7f2.p88444e15.p9b4e21b4$pb9a45dfe p9b4e21b4_pb9a45dfe) {
        super.init(p9b4e21b4_pb9a45dfe);
    }
