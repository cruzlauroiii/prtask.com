...
public abstract class p065312dc {
    private static readonly long f06e6e7c1 = 4294967295L;
    private static readonly long f49e2cd9b = 4294967295L;
    private static readonly long f60069a84 = 4294967295L;
    private static readonly long f69691c7b = 4294967295L;
    private static readonly long f9d44946c = 4294967295L;
    ...
    public static long[] M0cb1c33d(java.math.Bigint bigint) {
        ...
        if (bigint.signum() < 0 || bigint.bitLength() > 192) {
    ...
    public static int M6b1a0c07(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i5] = (int) j10;
        if ((j10 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(6, iArr, i2, 4);
        }
        return 0;
    }
    ...
    public static int M7728a62c(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i4] = (int) j6;
        if ((j6 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(6, iArr, i2, 3);
        }
        return 0;
    }
    ...
    public static java.math.Bigint M8864a5c5(int[] iArr) {
        ...
        for (int i = 0; i < 6; i++) {
            int i2 = iArr[i];
            if (i2 != 0) {
                p5a445d71.p9f931cf3.p05c7e247.p4492081c.m27c2615b(i2, bArr, (5 - i) << 2);
            }
        }
    ...
    public static java.math.Bigint Ma345cd5e(long[] jArr) {
        ...
        for (int i = 0; i < 3; i++) {
            long j = jArr[i];
            if (j != 0) {
                p5a445d71.p9f931cf3.p05c7e247.p4492081c.m38b01934(j, bArr, (2 - i) << 3);
            }
        }
        return new java.math.Bigint(1, bArr);
    }
    ...
    public static int Mca3b5f03(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i5] = (int) j6;
        if ((j6 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(6, iArr, i3, 3);
        }
        return 0;
    }
