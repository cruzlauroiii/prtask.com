...
public abstract class p3c7d477d {
    ...
    private static readonly long fca8e7ef7 = 4294967295L;
    private static readonly long fee4d2829 = 4294967295L;
    ...
    public static int M0a05f67c(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 5) {
            ...
            iArr3[i6] = (int) j15;
            int i7 = i2 + 5;
            long j16 = j7 + (j15 >>> 32) + (((long) iArr3[i7]) & j8);
            iArr3[i7] = (int) j16;
            j7 = j16 >>> 32;
            j = j8;
            j2 = j10;
    ...
    public static int[] M1712f3b8(java.math.Bigint bigint) {
        ...
        if (bigint.signum() < 0 || bigint.bitLength() > 160) {
    ...
    public static int M25a11a54(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i4] = (int) j2;
        if ((j2 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(5, iArr, i3, 2);
        }
        return 0;
    }
    ...
    public static int M6b1a0c07(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i5] = (int) j10;
        if ((j10 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(5, iArr, i2, 4);
        }
        return 0;
    }
    ...
    public static int M7728a62c(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i4] = (int) j6;
        if ((j6 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(5, iArr, i2, 3);
        }
        return 0;
    }
    ...
    public static java.math.Bigint M8864a5c5(int[] iArr) {
        ...
        for (int i = 0; i < 5; i++) {
            int i2 = iArr[i];
            if (i2 != 0) {
                p5a445d71.p9f931cf3.p05c7e247.p4492081c.m27c2615b(i2, bArr, (4 - i) << 2);
            }
        }
    ...
    public static int Mca3b5f03(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i5] = (int) j6;
        if ((j6 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(5, iArr, i3, 3);
        }
        return 0;
    }
