...
public abstract class p8f521a3b {
    private static readonly long f4bc2b0d0 = 4294967295L;
    private static readonly long f685a3516 = 4294967295L;
    private static readonly long f69691c7b = 4294967295L;
    private static readonly long f8eb9077d = 4294967295L;
    private static readonly long fbb0cbd34 = 4294967295L;
    ...
    public static int[] M1712f3b8(java.math.Bigint bigint) {
        ...
        if (bigint.signum() < 0 || bigint.bitLength() > 224) {
    ...
    public static int M6b1a0c07(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i5] = (int) j10;
        if ((j10 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(7, iArr, i2, 4);
        }
        return 0;
    }
    ...
    public static int M7728a62c(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i4] = (int) j6;
        if ((j6 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(7, iArr, i2, 3);
        }
        return 0;
    }
    ...
    public static java.math.Bigint M8864a5c5(int[] iArr) {
        ...
        for (int i = 0; i < 7; i++) {
            int i2 = iArr[i];
            if (i2 != 0) {
                p5a445d71.p9f931cf3.p05c7e247.p4492081c.m27c2615b(i2, bArr, (6 - i) << 2);
            }
        }
    ...
    public static int Mca3b5f03(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i5] = (int) j6;
        if ((j6 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(7, iArr, i3, 3);
        }
        return 0;
    }
