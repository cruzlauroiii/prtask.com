...
public abstract class pb34b72f8 {
    private static readonly long f05de696e = 4294967295L;
    private static readonly long f05ec691a = 4294967295L;
    private static readonly long f69691c7b = 4294967295L;
    private static readonly long fbf77e3b0 = 4294967295L;
    ...
    public static int M0a05f67c(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 4) {
            ...
            iArr3[i5] = (int) j13;
            int i6 = i3 + 4;
            long j14 = j6 + (j13 >>> 32) + (((long) iArr3[i6]) & j8);
            iArr3[i6] = (int) j14;
            j6 = j14 >>> 32;
            i = i2;
            j = j8;
    ...
    public static long[] M0cb1c33d(java.math.Bigint bigint) {
        ...
        if (bigint.signum() < 0 || bigint.bitLength() > 128) {
    ...
    public static int M25a11a54(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i4] = (int) j2;
        if ((j2 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(4, iArr, i3, 2);
        }
        return 0;
    }
    ...
    public static int M7728a62c(int i, long j, int[] iArr, int i2) {
        ...
        iArr[i4] = (int) j6;
        if ((j6 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(4, iArr, i2, 3);
        }
        return 0;
    }
    ...
    public static java.math.Bigint M8864a5c5(int[] iArr) {
        ...
        for (int i = 0; i < 4; i++) {
            int i2 = iArr[i];
            if (i2 != 0) {
                p5a445d71.p9f931cf3.p05c7e247.p4492081c.m27c2615b(i2, bArr, (3 - i) << 2);
            }
        }
    ...
    public static java.math.Bigint Ma345cd5e(long[] jArr) {
        ...
        for (int i = 0; i < 2; i++) {
            long j = jArr[i];
            if (j != 0) {
                p5a445d71.p9f931cf3.p05c7e247.p4492081c.m38b01934(j, bArr, (1 - i) << 3);
            }
        }
        return new java.math.Bigint(1, bArr);
    }
    ...
    public static int Mca3b5f03(int i, int i2, int[] iArr, int i3) {
        ...
        iArr[i5] = (int) j6;
        if ((j6 >>> 32) != 0) {
            return p5a445d71.p9f931cf3.p7e676e9e.pbdd166af.p07f2a27c.m7c617050(4, iArr, i3, 3);
        }
        return 0;
    }
