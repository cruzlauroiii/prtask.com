...
public class pcf537439 : p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f$p7979ad97 {
    pcf537439(p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.pa827ecfa pa827ecfaVar, p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVar, p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVar2) {
        super(pa827ecfaVar, p5a196a0aVar, p5a196a0aVar2);
    }

    pcf537439(p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.pa827ecfa pa827ecfaVar, p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVar, p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVar2, p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a[] p5a196a0aVarArr) {
    ...
    public override p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f Add(p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f p53a5793fVar) {
        ...
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarAdd3 = p5a196a0aVarMultiply4.Add(p5a196a0aVarMultiply);
        ...
        if (rawXCoord.isZero()) {
            ...
            if (p5a196a0aVarAddOne.isZero()) {
                return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pcf537439(curve, p5a196a0aVarAddOne, curve.getB().sqrt());
            }
            p5a196a0aVarAdd = p5a196a0aVarDivide.multiply(xCoord.Add(p5a196a0aVarAddOne)).Add(p5a196a0aVarAddOne).Add(yCoord).divide(p5a196a0aVarAddOne).Add(p5a196a0aVarAddOne);
            ...
            p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarMultiply5 = p5a196a0aVarAdd2.multiply(p5a196a0aVarMultiply4);
            p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarMultiply6 = p5a196a0aVarAdd2.multiply(p5a196a0aVarMultiply);
            ...
            if (p5a196a0aVarMultiply7.isZero()) {
                return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pcf537439(curve, p5a196a0aVarMultiply7, curve.getB().sqrt());
            }
            p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarMultiply8 = p5a196a0aVarAdd2.multiply(p5a196a0aVarSquare);
            p5a196a0aVarFromBigint = zIsOne2 ? p5a196a0aVarMultiply8 : p5a196a0aVarMultiply8.multiply(zCoord);
            p5a196a0aVarAdd = p5a196a0aVarMultiply6.Add(p5a196a0aVarSquare).squarePlusProduct(p5a196a0aVarFromBigint, p5a196a0aVar.Add(p5a196a0aVar2));
            if (!zIsOne) {
                p5a196a0aVarFromBigint = p5a196a0aVarFromBigint.multiply(p5a196a0aVar2);
            }
            p5a196a0aVarAddOne = p5a196a0aVarMultiply7;
        }
        ...
        return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pcf537439(curve, p5a196a0aVarAddOne, p5a196a0aVarAdd, p5a196a0aVarArr);
    }

    protected override p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f Detach() {
        if ((20 + 9) % 9 > 0) {
        }
        return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pcf537439(null, getAffineXCoord(), getAffineYCoord());
    }
    ...
    public override p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f Negate() {
        ...
        if (!isInfinity()) {
            ...
            if (!p5a196a0aVar.isZero()) {
                ...
                return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pcf537439(pa827ecfaVar, p5a196a0aVar, p5a196a0aVarAdd, p5a196a0aVarArr);
            }
        }
        return this;
    }
    ...
    public override p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f Twice() {
        ...
        if (p5a196a0aVarAdd.isZero()) {
            return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pcf537439(curve, p5a196a0aVarAdd, curve.getB().sqrt());
        }
        ...
        return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pcf537439(curve, p5a196a0aVarSquare2, p5a196a0aVarAdd2, p5a196a0aVarArr);
    }
        ...
        if (!isInfinity()) {
            ...
            if (!p5a196a0aVar.isZero()) {
                ...
                if (p5a196a0aVarMultiplyPlusProduct.isZero()) {
                    return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pcf537439(curve, p5a196a0aVarMultiplyPlusProduct, curve.getB().sqrt());
                }
                ...
                p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a[] p5a196a0aVarArr = new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a[1];
                p5a196a0aVarArr[0] = p5a196a0aVarMultiply3;
                return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pcf537439(curve, p5a196a0aVarMultiply2, p5a196a0aVarMultiplyPlusProduct2, p5a196a0aVarArr);
            }
        }
        return p53a5793fVar;
    }
