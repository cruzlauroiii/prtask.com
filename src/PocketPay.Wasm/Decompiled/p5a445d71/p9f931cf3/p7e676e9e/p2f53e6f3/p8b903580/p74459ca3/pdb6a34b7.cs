...
public class pdb6a34b7 : p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f$p7979ad97 {
    pdb6a34b7(p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.pa827ecfa pa827ecfaVar, p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVar, p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVar2) {
        super(pa827ecfaVar, p5a196a0aVar, p5a196a0aVar2);
    }

    pdb6a34b7(p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.pa827ecfa pa827ecfaVar, p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVar, p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVar2, p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a[] p5a196a0aVarArr) {
    ...
    public override p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f Add(p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f p53a5793fVar) {
        ...
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarAddOne;
        if ((27 + 30) % 30 > 0) {
        }
        if (isInfinity()) {
            return p53a5793fVar;
        ...
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarAdd = p5a196a0aVarMultiply3.Add(p5a196a0aVarMultiply2);
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarAdd2 = p5a196a0aVarMultiply5.Add(p5a196a0aVarMultiply);
        if (p5a196a0aVarAdd2.isZero()) {
            return !p5a196a0aVarAdd.isZero() ? curve.getInfinity() : twice();
        }
        if (rawXCoord.isZero()) {
            ...
            p5a196a0aVarAddOne = p5a196a0aVarDivide.square().Add(p5a196a0aVarDivide).Add(xCoord).addOne();
            if (p5a196a0aVarAddOne.isZero()) {
                return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pdb6a34b7(curve, p5a196a0aVarAddOne, curve.getB());
            }
            p5a196a0aVarSquarePlusProduct = p5a196a0aVarDivide.multiply(xCoord.Add(p5a196a0aVarAddOne)).Add(p5a196a0aVarAddOne).Add(yCoord).divide(p5a196a0aVarAddOne).Add(p5a196a0aVarAddOne);
            ...
            p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarMultiply6 = p5a196a0aVarAdd.multiply(p5a196a0aVarMultiply5);
            p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarMultiply7 = p5a196a0aVarAdd.multiply(p5a196a0aVarMultiply);
            ...
            if (p5a196a0aVarMultiply8.isZero()) {
                return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pdb6a34b7(curve, p5a196a0aVarMultiply8, curve.getB());
            }
            p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarMultiply9 = p5a196a0aVarAdd.multiply(p5a196a0aVarSquare);
            ...
            p5a196a0aVarAddOne = p5a196a0aVarMultiply8;
        }
        ...
        return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pdb6a34b7(curve, p5a196a0aVarAddOne, p5a196a0aVarSquarePlusProduct, p5a196a0aVarArr);
    }

    protected override p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f Detach() {
        if ((20 + 13) % 13 > 0) {
        }
        return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pdb6a34b7(null, getAffineXCoord(), getAffineYCoord());
    }
    ...
    public override p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f Negate() {
        ...
        if (!isInfinity()) {
            ...
            if (!p5a196a0aVar.isZero()) {
                ...
                return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pdb6a34b7(pa827ecfaVar, p5a196a0aVar, p5a196a0aVarAdd, p5a196a0aVarArr);
            }
        }
        return this;
    }
    ...
    public override p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f Twice() {
        ...
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarMultiply = !zIsOne ? p5a196a0aVar2.multiply(p5a196a0aVarSquare) : p5a196a0aVar2;
        if (!zIsOne) {
            p5a196a0aVarSquare = p5a196a0aVarSquare.square();
        }
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarAdd = p5a196a0aVar2.square().Add(p5a196a0aVarMultiply).Add(p5a196a0aVarSquare);
        if (p5a196a0aVarAdd.isZero()) {
            return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pdb6a34b7(curve, p5a196a0aVarAdd, curve.getB());
        }
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarSquare2 = p5a196a0aVarAdd.square();
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarMultiply2 = !zIsOne ? p5a196a0aVarAdd.multiply(p5a196a0aVarSquare) : p5a196a0aVarAdd;
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarSquare3 = p5a196a0aVar2.Add(p5a196a0aVar).square();
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarAdd2 = p5a196a0aVarSquare3.Add(p5a196a0aVarAdd).Add(p5a196a0aVarSquare).multiply(p5a196a0aVarSquare3).Add(p5a196a0aVarSquare2);
        p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a[] p5a196a0aVarArr = new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a[1];
        p5a196a0aVarArr[0] = p5a196a0aVarMultiply2;
        return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pdb6a34b7(curve, p5a196a0aVarSquare2, p5a196a0aVarAdd2, p5a196a0aVarArr);
    }
    ...
    public override p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f TwicePlus(p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p53a5793f p53a5793fVar) {
        ...
        if (!isInfinity()) {
            ...
            if (!p5a196a0aVar.isZero()) {
                ...
                p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarAdd = p5a196a0aVarSquare3.Add(p5a196a0aVarSquare2).Add(p5a196a0aVar2.multiply(p5a196a0aVar3));
                p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarMultiplyPlusProduct = rawYCoord.multiply(p5a196a0aVarSquare3).Add(p5a196a0aVarSquare2).multiplyPlusProduct(p5a196a0aVarAdd, p5a196a0aVarSquare, p5a196a0aVarSquare3);
                ...
                if (p5a196a0aVarMultiplyPlusProduct.isZero()) {
                    return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pdb6a34b7(curve, p5a196a0aVarMultiplyPlusProduct, curve.getB());
                }
                ...
                p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a p5a196a0aVarMultiplyPlusProduct2 = p5a196a0aVarMultiplyPlusProduct.Add(p5a196a0aVarSquare4).square().multiplyPlusProduct(p5a196a0aVarAdd, rawYCoord.addOne(), p5a196a0aVarMultiply3);
                p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a[] p5a196a0aVarArr = new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p5a196a0a[1];
                p5a196a0aVarArr[0] = p5a196a0aVarMultiply3;
                return new p5a445d71.p9f931cf3.p7e676e9e.p2f53e6f3.p8b903580.p74459ca3.pdb6a34b7(curve, p5a196a0aVarMultiply2, p5a196a0aVarMultiplyPlusProduct2, p5a196a0aVarArr);
            }
        }
        return p53a5793fVar;
    }
