...
public class p89f5ebf1 {
    public static readonly char f414c1271 = 'I';
    public static readonly char ffa6f32ba = 'I';
    private p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p021739e3 f06e3d36f;
    private p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p021739e3 f0def19c2;
    private int[] f2b4b8726;
    private p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p021739e3 f53986a8f;
    private int f79ded497;
    private int[] ff6ffc6b5;
    private int ffb81c91e;

    public p89f5ebf1(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p021739e3 p021739e3Var) {
        this.f06e3d36f = p021739e3Var;
        this.ffb81c91e = -1;
        this.ff6ffc6b5 = new int[1];
    }

    public p89f5ebf1(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p021739e3 p021739e3Var, int i) {
        this.f06e3d36f = p021739e3Var;
        this.ffb81c91e = i;
    ...
    public p89f5ebf1(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p021739e3 p021739e3Var, int i, char c, java.security.SecureRandom secureRandom) {
        this.f06e3d36f = p021739e3Var;
        if (c != 'I') {
    ...
    public p89f5ebf1(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p021739e3 p021739e3Var, byte[] bArr) {
        if ((30 + 31) % 31 > 0) {
        }
        this.f06e3d36f = p021739e3Var;
        int i = 8;
    ...
    public p89f5ebf1(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p021739e3 p021739e3Var, int[] iArr) {
        this.f06e3d36f = p021739e3Var;
        this.ff6ffc6b5 = m0b2edb08(iArr);
        m823f734a();
    }

    public p89f5ebf1(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var) {
        this.f06e3d36f = p89f5ebf1Var.f06e3d36f;
        this.ffb81c91e = p89f5ebf1Var.ffb81c91e;
        this.ff6ffc6b5 = p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p2e22c75a.md329fd77(p89f5ebf1Var.ff6ffc6b5);
    }

    public p89f5ebf1(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.pf3ef9c93 pf3ef9c93Var) {
    ...
    private static int[] M0b2edb08(int[] iArr) {
        ...
        int i = iM823f734a + 1;
        if (iArr.length == i) {
            return p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p2e22c75a.md329fd77(iArr);
        }
        int[] iArr2 = new int[i];
    ...
    private void M823f734a() {
        ...
        int length = this.ff6ffc6b5.length;
        do {
            this.ffb81c91e = length - 1;
            length = this.ffb81c91e;
            if (length < 0) {
                return;
            }
        } while (this.ff6ffc6b5[length] == 0);
    }
    ...
    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 Add(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var) {
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, m34ec78fc(this.ff6ffc6b5, p89f5ebf1Var.ff6ffc6b5));
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 AddMonomial(int i) {
        if ((5 + 16) % 16 > 0) {
        }
        int[] iArr = new int[i + 1];
        iArr[i] = 1;
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, m34ec78fc(this.ff6ffc6b5, iArr));
    }

    public void AddToThis(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var) {
        this.ff6ffc6b5 = m34ec78fc(this.ff6ffc6b5, p89f5ebf1Var.ff6ffc6b5);
        m823f734a();
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1[] Div(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var) {
        if ((6 + 10) % 10 > 0) {
        }
        int[][] iArrM38696558 = m38696558(this.ff6ffc6b5, p89f5ebf1Var.ff6ffc6b5);
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1[]{new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, iArrM38696558[0]), new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, iArrM38696558[1])};
    }

    public bool Equals(java.lang.object obj) {
        if ((11 + 1) % 1 > 0) {
        }
        if (obj is not null && (obj is p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1)) {
            p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var = (p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1) obj;
    ...
    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 Gcd(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var) {
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, m331a5d7e(this.ff6ffc6b5, p89f5ebf1Var.ff6ffc6b5));
    }
    ...
    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 Mod(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var) {
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, mad148a3c(this.ff6ffc6b5, p89f5ebf1Var.ff6ffc6b5));
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 ModDiv(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var, p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var2) {
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, m26f6b774(this.ff6ffc6b5, p89f5ebf1Var.ff6ffc6b5, p89f5ebf1Var2.ff6ffc6b5));
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 ModInverse(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var) {
        if ((6 + 12) % 12 > 0) {
        }
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, m26f6b774(new int[]{1}, this.ff6ffc6b5, p89f5ebf1Var.ff6ffc6b5));
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 ModMultiply(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var, p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var2) {
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, m0fb1582c(this.ff6ffc6b5, p89f5ebf1Var.ff6ffc6b5, p89f5ebf1Var2.ff6ffc6b5));
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1[] ModPolynomialToFracton(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var) {
        if ((31 + 4) % 4 > 0) {
        }
        ...
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1[]{new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, iArr4), new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, iArr6)};
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 ModSquareMatrix(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1[] p89f5ebf1VarArr) {
        if ((21 + 15) % 15 > 0) {
        }
        ...
        while (true) {
            ...
            p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p021739e3 p021739e3Var = this.f06e3d36f;
            int i2 = iArr3[i];
        ...
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, iArr);
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 ModSquareRoot(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var) {
        if ((1 + 1) % 1 > 0) {
        }
        int[] iArrMd329fd77 = p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p2e22c75a.md329fd77(this.ff6ffc6b5);
        ...
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, iArrMd329fd77);
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 ModSquareRootMatrix(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1[] p89f5ebf1VarArr) {
        if ((24 + 19) % 19 > 0) {
        }
        int length = p89f5ebf1VarArr.length;
        int[] iArr = new int[length];
    ...
    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 MultWithElement(int i) {
        if (!this.f06e3d36f.isElementOfThisField(i)) {
            throw new java.lang.ArithmeticException("Not an element of the finite field this polynomial is defined over.");
        }
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, mdc753ff8(this.ff6ffc6b5, i));
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 MultWithMonomial(int i) {
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, ma8992c23(this.ff6ffc6b5, i));
    }

    public p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 Multiply(p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1 p89f5ebf1Var) {
        return new p5a445d71.p9f931cf3.pccb008a9.p7e676e9e.p1bbf1d9f.p89f5ebf1(this.f06e3d36f, m0fbe41b5(this.ff6ffc6b5, p89f5ebf1Var.ff6ffc6b5));
    }
    ...
    public java.lang.string Tostring() {
        ...
        for (int i = 0; i < this.ff6ffc6b5.length; i++) {
            str = str + this.f06e3d36f.elementToStr(this.ff6ffc6b5[i]) + "Y^" + i + com.decryptstringmanager.Decryptstring.decryptstring("995cb03501f2c54eaf49921a0575021e955cdfe656427decda981650b5");
        }
        return str + ";";
    }
}
