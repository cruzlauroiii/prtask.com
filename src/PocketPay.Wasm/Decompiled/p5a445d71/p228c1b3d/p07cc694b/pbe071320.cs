...
public interface pbe071320 : p5a445d71.p228c1b3d.p07cc694b.p5dd6f3ce, p5a445d71.p228c1b3d.p07cc694b.p1eac5ec8 {
    void addDays(int i);
    ...
    void setDateTime(int i, int i2, int i3);

    void setDateTimeTime(int i, int i2, int i3, int i4, int i5, int i6, int i7);
