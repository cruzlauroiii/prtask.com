...
var PrerenderRoutes = new (string Route, Type PageType)[]
{
    ...
    (PrerenderConstants.RouteConfirmationEmails, typeof(PrTask.SharedUI.Pages.ConfirmationEmailsPage)),
    (PrerenderConstants.RouteSystemLogs, typeof(PrTask.SharedUI.Pages.SystemLogsPage)),
    (PrerenderConstants.RouteScreenshots, typeof(PrTask.SharedUI.Pages.ScreenshotsPage)),
